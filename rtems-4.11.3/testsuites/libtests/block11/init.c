...
static rtems_status_code invalid_initialize (rtems_device_major_number major,
...
static rtems_status_code invalid_control (rtems_device_major_number major,
										  rtems_device_minor_number minor,
										  void *arg)
{
...
static void test_blkdev_imfs_errors (void)
{
	...
	rv = mknod (invalid_blkdev, S_IFBLK | S_IRWXU | S_IRWXG | S_IRWXO,
				st.st_rdev);
	rtems_test_assert (rv == 0);

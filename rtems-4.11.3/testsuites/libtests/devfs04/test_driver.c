 ...
 */
rtems_device_driver testDriver_initialize (rtems_device_major_number major,
	...
	if (!initialized)
	  {
		  ...
		  status = rtems_io_register_name ("/dev/test",
										   major,
 ...
 *    rval       - RTEMS_SUCCESSFUL
 */
rtems_device_driver testDriver_open (rtems_device_major_number major
									 __attribute__ ((unused)),
									 rtems_device_minor_number minor
									 __attribute__ ((unused)), void *pargp
									 __attribute__ ((unused)))
 ...
 *    rval       - RTEMS_SUCCESSFUL
 */
rtems_device_driver testDriver_close (rtems_device_major_number major
									  __attribute__ ((unused)),
									  rtems_device_minor_number minor
									  __attribute__ ((unused)), void *pargp
									  __attribute__ ((unused)))
 ...
 *    rval       - RTEMS_SUCCESSFUL
 */
rtems_device_driver testDriver_read (rtems_device_major_number major
									 __attribute__ ((unused)),
									 rtems_device_minor_number minor
									 __attribute__ ((unused)), void *pargp)
{
 ...
 *    rval       - RTEMS_SUCCESSFUL
 */
rtems_device_driver testDriver_write (rtems_device_major_number major
									  __attribute__ ((unused)),
									  rtems_device_minor_number minor
									  __attribute__ ((unused)), void *pargp)
{
...
rtems_device_driver testDriver_control (rtems_device_major_number major
										__attribute__ ((unused)),
										rtems_device_minor_number minor
										__attribute__ ((unused)), void *pargp
										__attribute__ ((unused)))

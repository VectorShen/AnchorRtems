...
static void test_md5 (const uint8_t * key,
					  size_t key_size,
					  const uint8_t * data,
					  size_t data_size,
					  const uint8_t expected_digest[MD5_DIGEST_LENGTH])
{
	...
	rtems_test_assert (memcmp
					   (&outer_digest[0], expected_digest,
						sizeof (outer_digest)) == 0);
}

static void test (void)
{
	test_md5 (&key_1[0], sizeof (key_1), &data_1[0], sizeof (data_1),
			  &digest_1[0]);
	test_md5 (&key_2[0], sizeof (key_2), &data_2[0], sizeof (data_2),
			  &digest_2[0]);
	test_md5 (&key_3[0], sizeof (key_3), &data_3[0], sizeof (data_3),
			  &digest_3[0]);
	test_md5 (&key_4[0], sizeof (key_4), &data_4[0], sizeof (data_4),
			  &digest_4[0]);
	test_md5 (&key_5[0], sizeof (key_5), &data_5[0], sizeof (data_5),
			  &digest_5[0]);
	test_md5 (&key_6[0], sizeof (key_6), &data_6[0], sizeof (data_6),
			  &digest_6[0]);
	test_md5 (&key_7[0], sizeof (key_7), &data_7[0], sizeof (data_7),
			  &digest_7[0]);
}

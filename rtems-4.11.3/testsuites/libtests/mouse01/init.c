...
bool enqueue_next_action (const unsigned char *actions,
						  size_t max, size_t to_enqueue);
void open_it (void);
...
void printf_uid_message (struct MW_UID_MESSAGE *uid)
{
	uid_print_message_with_plugin (stdout,
								   (rtems_printk_plugin_t) fprintf, uid);
}
...
rtems_task Init (rtems_task_argument ignored)
{
	...
	do
	  {
		  more_data = enqueue_next_action (Mouse_Actions,
										   Mouse_Actions_Size,

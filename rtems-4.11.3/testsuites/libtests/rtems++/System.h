...
rtems_timer_service_routine Delayed_routine (rtems_id ignored_id,
											 void *ignored_address);

class Task1:public rtemsTask
{
...
class EndTask:public rtemsTask
{
  protected:
	virtual void body (rtems_task_argument argument);
...
class Service_routine:public rtemsInterrupt
{
};

class Io_during_interrupt:pubic rtemsTimer
{

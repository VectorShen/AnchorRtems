...
extern "C"
{
	...
	typedef int (*test_file_system_mount_handler) (const char *disk_path,
												   const char *mount_path,
												   void *arg);

	typedef int (*test_file_system_format_handler) (const char *disk_path,
													void *arg);
	...
	void test_file_system_with_handler (unsigned index,
										...
										const char *mount_path,
										const test_file_system_handler *

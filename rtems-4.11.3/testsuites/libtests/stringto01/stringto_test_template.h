...
void TEST_STRING_TO_NAME (void)
{
	...
	puts (STRING_TO_NAME_METHOD_STRING
	...
	puts (STRING_TO_NAME_METHOD_STRING " - " GOOD_VALUE_STRING
	...
	endptr = NULL;
	puts (STRING_TO_NAME_METHOD_STRING " - MAXIMUM VALUE"
	...
	endptr = NULL;
	puts (STRING_TO_NAME_METHOD_STRING " - " BAD_VALUE_STRING

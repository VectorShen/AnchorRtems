...
*/
typedef void (*rtems_blkdev_request_cb) (struct rtems_blkdev_request * req,
...
*/
static inline void rtems_blkdev_request_done (rtems_blkdev_request * req,
											  rtems_status_code status)
{
	(*req->done) (req, status);
}
...
static inline int rtems_disk_fd_get_block_size (int fd,
												uint32_t * block_size)
{
...
static inline int rtems_disk_fd_get_block_count (int fd,
												 rtems_blkdev_bnum *
												 block_count)
{
...
static inline int rtems_disk_fd_get_disk_device (int fd,
												 rtems_disk_device **
												 dd_ptr)
{
...
static inline int rtems_disk_fd_get_device_stats (int fd,
												  rtems_blkdev_stats *
												  stats)
{
...
*/
void rtems_blkdev_print_stats (const rtems_blkdev_stats * stats,
...
*/
rtems_device_driver
	rtems_blkdev_generic_read (rtems_device_major_number major,
...
*/
rtems_device_driver
	rtems_blkdev_generic_write (rtems_device_major_number major,
								rtems_device_minor_number minor, void *arg);
...
*/
rtems_device_driver
	rtems_blkdev_generic_open (rtems_device_major_number major,
							   rtems_device_minor_number minor, void *arg);
...
*/
rtems_device_driver
	rtems_blkdev_generic_close (rtems_device_major_number major,
								rtems_device_minor_number minor, void *arg);
...
*/
rtems_device_driver
	rtems_blkdev_generic_ioctl (rtems_device_major_number major,
								rtems_device_minor_number minor, void *arg);

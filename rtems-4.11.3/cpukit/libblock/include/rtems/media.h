...
*/
typedef rtems_status_code (*rtems_media_listener) (rtems_media_event event,
...
*/
typedef rtems_status_code (*rtems_media_worker) (rtems_media_state state,
												 const char *src,
												 char **dest,
												 void *worker_arg);
...
*/
rtems_status_code rtems_media_listener_remove (rtems_media_listener
											   listener,
											   void *listener_arg);
...
*/
static inline rtems_status_code rtems_media_server_disk_attach (const char
																*driver_name,
																rtems_media_worker
																worker,
																void
																*worker_arg)
{
	return rtems_media_server_post_event (RTEMS_MEDIA_EVENT_DISK_ATTACH,
										  driver_name, worker, worker_arg);
}

/**
* @brief See rtems_media_server_post_event().
*/
static inline rtems_status_code rtems_media_server_disk_detach (const char
																*disk_path)
{
	return rtems_media_server_post_event (RTEMS_MEDIA_EVENT_DISK_DETACH,
										  disk_path, NULL, NULL);
}
...
*/
rtems_status_code rtems_media_get_device_identifier (const char
													 *device_path,
													 dev_t *
													 device_identifier);

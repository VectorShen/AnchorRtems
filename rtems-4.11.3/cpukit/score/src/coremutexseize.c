...
void _CORE_mutex_Seize (CORE_mutex_Control * _the_mutex,
						Thread_Control * _executing,
						Objects_Id _id,
						bool _wait,
						Watchdog_Interval _timeout, ISR_Level _level)
{
	_CORE_mutex_Seize_body (_the_mutex,
							_executing, _id, _wait, _timeout, _level);
}
#endif
										   ...
										   ISR_lock_Context * lock_context)
{
	...
	_Thread_queue_Enqueue_critical (&the_mutex->Wait_queue,
									...
									timeout, CORE_MUTEX_TIMEOUT, lock_context);

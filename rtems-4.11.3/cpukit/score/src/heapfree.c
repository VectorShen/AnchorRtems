...
#else
static void _Heap_Protection_delay_block_free (Heap_Control * heap,
											   Heap_Block * block)
{
...
static void _Heap_Protection_check_free_block (Heap_Control * heap,
											   Heap_Block * block)
{
	uintptr_t *const pattern_begin = (uintptr_t *)
		_Heap_Alloc_area_of_block (block);
...
static bool _Heap_Protection_determine_block_free (Heap_Control * heap,
												   Heap_Block * block)
{
	bool do_free = true;

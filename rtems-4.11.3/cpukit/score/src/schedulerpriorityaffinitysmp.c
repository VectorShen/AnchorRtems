...
static bool _Scheduler_priority_affinity_SMP_Insert_priority_lifo_order (const
																		 Chain_Node
																		 *
																		 to_insert,
																		 const
...
static bool _Scheduler_priority_affinity_SMP_Insert_priority_fifo_order (const
																		 Chain_Node
																		 *
																		 to_insert,
																		 const
...
static Scheduler_priority_affinity_SMP_Node
	*_Scheduler_priority_affinity_SMP_Thread_get_own_node (Thread_Control *
														 thread)
{
 ...
 */
static Scheduler_priority_affinity_SMP_Node
	*_Scheduler_priority_affinity_SMP_Thread_get_node (Thread_Control * thread)
{
	return (Scheduler_priority_affinity_SMP_Node *)
 ...
 */
void _Scheduler_priority_affinity_SMP_Node_initialize (const Scheduler_Control *
													 scheduler,
 ...
 */
static inline void _Scheduler_SMP_Allocate_processor_exact (Scheduler_Context *
															context,
															Thread_Control *
															scheduled_thread,
															Thread_Control *
 ...
 */
static Scheduler_Node
	*_Scheduler_priority_affinity_SMP_Get_highest_ready (Scheduler_Context *
														 context,
														 Scheduler_Node *
														 victim)
{
	...
	if (victim == NULL)
	{
		node = (Scheduler_priority_affinity_SMP_Node *)
			_Scheduler_priority_Ready_queue_first (&self->Bit_map,
													 &self->Ready[0]);
 ...
 */
void _Scheduler_priority_affinity_SMP_Block (const Scheduler_Control *
											 scheduler, Thread_Control * thread)
{
	Scheduler_Context *context = _Scheduler_Get_context (scheduler);

	_Scheduler_SMP_Block (context,
						thread,
						_Scheduler_priority_SMP_Extract_from_ready,
 ...
 */
static Scheduler_Node
	*_Scheduler_priority_affinity_SMP_Get_lowest_scheduled (Scheduler_Context *
															context,
															Scheduler_Node *
															filter_base,
															Chain_Node_order
															order)
{
		 ...
		 chain_node = _Chain_Previous (chain_node))
	{
		 ...
		 */
		if ((*order)
			(&node->Base.Base.Base.Node, &filter->Base.Base.Base.Node))
			break;
...
static Thread_Control
	*_Scheduler_priority_affinity_SMP_Enqueue_fifo (Scheduler_Context * context,
													Scheduler_Node * node,
													Thread_Control * needs_help)
{
	return _Scheduler_SMP_Enqueue_ordered (context,
										 node,
										 needs_help,
 ...
 */
static void
_Scheduler_priority_affinity_SMP_Check_for_migrations (Scheduler_Context *
													 context)
{
	...
	{
		highest_ready =
			_Scheduler_priority_affinity_SMP_Get_highest_ready (context,
																NULL);

		lowest_scheduled =
			_Scheduler_priority_affinity_SMP_Get_lowest_scheduled (context,
																	 highest_ready,
		...
		_Scheduler_SMP_Node_change_state (_Scheduler_SMP_Node_downcast
											(lowest_scheduled),
											SCHEDULER_SMP_NODE_READY);
		_Scheduler_Thread_change_state (_Scheduler_Node_get_user
										(lowest_scheduled),
										THREAD_SCHEDULER_READY);

		_Scheduler_SMP_Allocate_processor (context,
											 highest_ready,
											 lowest_scheduled,
											 _Scheduler_SMP_Allocate_processor_exact);

		_Scheduler_priority_SMP_Move_from_ready_to_scheduled (context,
																highest_ready);

		_Scheduler_priority_SMP_Move_from_scheduled_to_ready (context,
																lowest_scheduled);
	}
}
 ...
 */
Thread_Control *_Scheduler_priority_affinity_SMP_Unblock (const
														Scheduler_Control *
														scheduler,
														Thread_Control *
														thread)
{
	...
	needs_help = _Scheduler_SMP_Unblock (context,
										 thread,
 ...
 */
static Thread_Control
	*_Scheduler_priority_affinity_SMP_Enqueue_ordered (Scheduler_Context *
													 context,
													 Scheduler_Node * node,
													 Thread_Control *
													 needs_help,
 ...
 */
static Thread_Control
	*_Scheduler_priority_affinity_SMP_Enqueue_lifo (Scheduler_Context * context,
													Scheduler_Node * node,
													Thread_Control * needs_help)
{
	return _Scheduler_priority_affinity_SMP_Enqueue_ordered (context,
															 node,
															 needs_help,
...
static Thread_Control
	*_Scheduler_priority_affinity_SMP_Enqueue_scheduled_ordered
	(Scheduler_Context * context, Scheduler_Node * node, Chain_Node_order order,
	 Scheduler_SMP_Insert insert_ready, Scheduler_SMP_Insert insert_scheduled)
{
	return _Scheduler_SMP_Enqueue_scheduled_ordered (context,
													 node,
													 order,
													 _Scheduler_priority_SMP_Extract_from_ready,
													 _Scheduler_priority_affinity_SMP_Get_highest_ready,
 ...
 */
static Thread_Control
	*_Scheduler_priority_affinity_SMP_Enqueue_scheduled_lifo (Scheduler_Context
															* context,
															Scheduler_Node *
															node)
{
	return _Scheduler_priority_affinity_SMP_Enqueue_scheduled_ordered (context,
																	 node,
																	 _Scheduler_SMP_Insert_priority_lifo_order,
																	 _Scheduler_priority_SMP_Insert_ready_lifo,
																	 _Scheduler_SMP_Insert_scheduled_lifo);
 ...
 */
static Thread_Control
	*_Scheduler_priority_affinity_SMP_Enqueue_scheduled_fifo (Scheduler_Context
															* context,
															Scheduler_Node *
															node)
{
 ...
 */
Thread_Control *_Scheduler_priority_affinity_SMP_Change_priority (const
																Scheduler_Control
																* scheduler,
																Thread_Control
																* thread,
																...
																prepend_it)
{
	...
	displaced = _Scheduler_SMP_Change_priority (context,
												thread,
												new_priority,
												prepend_it,
												_Scheduler_priority_SMP_Extract_from_ready,
...
Thread_Control *_Scheduler_priority_affinity_SMP_Ask_for_help (const
															 Scheduler_Control
															 * scheduler,
															 Thread_Control *
															 offers_help,
															 ...
															 needs_help)
{
	...
	needs_help = _Scheduler_SMP_Ask_for_help (context,
											offers_help,
											needs_help,
											_Scheduler_priority_affinity_SMP_Enqueue_fifo);
 ...
 * This is the public scheduler specific Change Priority operation.
 */
bool _Scheduler_priority_affinity_SMP_Get_affinity (const Scheduler_Control *
													scheduler,
													Thread_Control * thread,
													size_t cpusetsize,
													cpu_set_t * cpuset)
...
bool _Scheduler_priority_affinity_SMP_Set_affinity (const Scheduler_Control *
													scheduler,
													Thread_Control * thread,
													size_t cpusetsize,

							 ...
							 Priority_Control new_priority)
{
	_Thread_Change_priority (the_thread,
							 new_priority,
							 NULL, _Thread_Raise_priority_filter, false);
}

static bool _Thread_Restore_priority_filter (Thread_Control * the_thread,
											 Priority_Control * new_priority,
											 void *arg)
{
...
{
	_Thread_Change_priority (the_thread,
							 0, NULL, _Thread_Restore_priority_filter, true);
}

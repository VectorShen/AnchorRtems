...
#if defined(RTEMS_SMP)
const size_t _Scheduler_Count = RTEMS_ARRAY_SIZE (_Scheduler_Table);
...
RTEMS_STATIC_ASSERT (CONFIGURE_SMP_MAXIMUM_PROCESSORS
...
#ifdef RTEMS_POSIX_API
	, {
	   offsetof (Configuration_Thread_control,

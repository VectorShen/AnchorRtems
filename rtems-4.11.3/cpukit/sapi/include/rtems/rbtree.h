 ...
 */
	RTEMS_INLINE_ROUTINE void rtems_rbtree_initialize (rtems_rbtree_control *
													   the_rbtree,
 ...
 */
	RTEMS_INLINE_ROUTINE void
		rtems_rbtree_initialize_empty (rtems_rbtree_control * the_rbtree)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE void rtems_rbtree_set_off_tree (rtems_rbtree_node *
														 node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE bool rtems_rbtree_is_node_off_tree (const
															 rtems_rbtree_node *
															 node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE rtems_rbtree_node *rtems_rbtree_root (const
 ...
 */
	RTEMS_INLINE_ROUTINE rtems_rbtree_node *rtems_rbtree_min (const
															  rtems_rbtree_control
															  * the_rbtree)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE rtems_rbtree_node *rtems_rbtree_max (const
															  rtems_rbtree_control
															  * the_rbtree)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE rtems_rbtree_node *rtems_rbtree_left (const
															   rtems_rbtree_node
															   * the_node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE rtems_rbtree_node *rtems_rbtree_right (const
																rtems_rbtree_node
																* the_node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE rtems_rbtree_node *rtems_rbtree_parent (const
																 rtems_rbtree_node
																 * the_node)
	{
 ...
 * false otherwise.
 */
	RTEMS_INLINE_ROUTINE bool rtems_rbtree_is_empty (const rtems_rbtree_control
													 * the_rbtree)
	{
 ...
 * and false otherwise.
 */
	RTEMS_INLINE_ROUTINE bool rtems_rbtree_is_min (const rtems_rbtree_control *
												   the_rbtree,
 ...
 * and false otherwise.
 */
	RTEMS_INLINE_ROUTINE bool rtems_rbtree_is_max (const rtems_rbtree_control *
												   the_rbtree,
												   const rtems_rbtree_node *
												   the_node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE bool rtems_rbtree_is_root (const rtems_rbtree_node *
													the_node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE rtems_rbtree_node *rtems_rbtree_find (const
															   rtems_rbtree_control
															   * the_rbtree,
															   const
															   rtems_rbtree_node
 ...
 */
	RTEMS_INLINE_ROUTINE rtems_rbtree_node *rtems_rbtree_predecessor (const
																	  rtems_rbtree_node
																	  * node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE rtems_rbtree_node *rtems_rbtree_successor (const
																	rtems_rbtree_node
																	* node)
	{
 ...
 */
	...
	RTEMS_INLINE_ROUTINE rtems_rbtree_node
		*rtems_rbtree_get_min (rtems_rbtree_control * the_rbtree)
	{
 ...
 */
	...
	RTEMS_INLINE_ROUTINE rtems_rbtree_node
		*rtems_rbtree_get_max (rtems_rbtree_control * the_rbtree)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE rtems_rbtree_node *rtems_rbtree_peek_min (const
																   rtems_rbtree_control
																   * the_rbtree)
	{
		return _RBTree_First (the_rbtree, RBT_LEFT);
 ...
 * then NULL is returned.
 */
	RTEMS_INLINE_ROUTINE rtems_rbtree_node *rtems_rbtree_peek_max (const
																   rtems_rbtree_control
																   * the_rbtree)
	{
		return _RBTree_First (the_rbtree, RBT_RIGHT);
 ...
 */
	RTEMS_INLINE_ROUTINE rtems_rbtree_node
		*rtems_rbtree_insert (rtems_rbtree_control * the_rbtree,
							  rtems_rbtree_node * the_node,
							  rtems_rbtree_compare compare, bool is_unique)
	{

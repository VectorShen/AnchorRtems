...
*/
typedef void rtems_timecounter_simple_at_tick (rtems_timecounter_simple *
											   tc);

/**
* @brief Returns the current value of a simple timecounter.
*/
typedef uint32_t rtems_timecounter_simple_get (rtems_timecounter_simple *
											   tc);
...
* false otherwise.
*/
typedef bool rtems_timecounter_simple_is_pending (rtems_timecounter_simple *
												  tc);
...
*/
RTEMS_INLINE_ROUTINE uint32_t rtems_timecounter_simple_scale (const
															  rtems_timecounter_simple
															  * tc,
															  uint32_t
															  value)
...
RTEMS_INLINE_ROUTINE void
	rtems_timecounter_simple_downcounter_tick (rtems_timecounter_simple *
											   tc,
											   rtems_timecounter_simple_get
											   get,
											   rtems_timecounter_simple_at_tick
											   at_tick)
{
	...
	current = rtems_timecounter_simple_scale (tc,
											  tc->real_interval -
											  (*get) (tc));
...
*/
RTEMS_INLINE_ROUTINE void
	rtems_timecounter_simple_upcounter_tick (rtems_timecounter_simple * tc,
											 rtems_timecounter_simple_get
											 get,
											 rtems_timecounter_simple_at_tick
											 at_tick)
...
RTEMS_INLINE_ROUTINE uint32_t
	rtems_timecounter_simple_downcounter_get (struct timecounter *tc_base,
											  rtems_timecounter_simple_get
											  get,
											  rtems_timecounter_simple_is_pending
											  is_pending)
{
...
* simple timecounter is pending.
*/
RTEMS_INLINE_ROUTINE uint32_t rtems_timecounter_simple_upcounter_get (struct
																	  timecounter
																	  *
																	  tc_base,
																	  rtems_timecounter_simple_get

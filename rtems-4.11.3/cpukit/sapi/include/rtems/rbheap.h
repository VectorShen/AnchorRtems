 ...
 */
	typedef void (*rtems_rbheap_extend_descriptors) (rtems_rbheap_control *
													 control);
 ...
 */
	...
	static inline rtems_chain_control
		*rtems_rbheap_get_spare_descriptor_chain (rtems_rbheap_control *
												  control)
	{
	...
	static inline void
		rtems_rbheap_add_to_spare_descriptor_chain (rtems_rbheap_control *
													control,
	...
	static inline void rtems_rbheap_set_extend_descriptors (rtems_rbheap_control
															* control,
															rtems_rbheap_extend_descriptors
															extend_descriptors)
	{
	...
	static inline void *rtems_rbheap_get_handler_arg (const rtems_rbheap_control
													  * control)
	{
		return control->handler_arg;
	}

	static inline void rtems_rbheap_set_handler_arg (rtems_rbheap_control *
													 control, void *handler_arg)
	{
...
#define rtems_rbheap_chunk_of_node(node) \
  RTEMS_CONTAINER_OF(node, rtems_rbheap_chunk, tree_node)
	...
	static inline bool rtems_rbheap_is_chunk_free (const rtems_rbheap_chunk *
												   chunk)
	{

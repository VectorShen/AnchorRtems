...
*/
RTEMS_INLINE_ROUTINE bool rtems_timespec_is_valid (const struct timespec
												   *time)
{
...
*
*/
RTEMS_INLINE_ROUTINE bool rtems_timespec_less_than (const struct timespec *
													lhs,
...
*/
RTEMS_INLINE_ROUTINE uint32_t rtems_timespec_to_ticks (const struct timespec
													   * time)
{
...
*/
RTEMS_INLINE_ROUTINE void rtems_timespec_subtract (const struct timespec
												   *start,
												   const struct timespec
												   *end,
...
* @return This method fills in @a result.
*/
RTEMS_INLINE_ROUTINE void rtems_timespec_divide_by_integer (const struct
															timespec *time,
															uint32_t
															iterations,
															struct timespec
...
*/
RTEMS_INLINE_ROUTINE time_t rtems_timespec_get_seconds (struct timespec
														*_time)
{
...
*/
RTEMS_INLINE_ROUTINE uint32_t rtems_timespec_get_nanoseconds (struct
															  timespec *
															  _time)
{
...
*/
RTEMS_INLINE_ROUTINE bool rtems_timespec_greater_than (const struct timespec
													   * _lhs,
													   const struct timespec
													   * _rhs)
{
...
*/
RTEMS_INLINE_ROUTINE bool rtems_timespec_equal_to (const struct timespec *
												   lhs,
												   const struct timespec *
												   rhs)
{

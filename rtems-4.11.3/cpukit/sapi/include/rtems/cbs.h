 ...
 * @return status code.
 */
	RTEMS_INLINE_ROUTINE int rtems_cbs_create_server (rtems_cbs_parameters *
													  params,
													  ...
													  server_id)
	{
		return _Scheduler_CBS_Create_server (params,
											 budget_overrun_callback,
											 server_id);
	}
 ...
 * @return status code.
 */
	RTEMS_INLINE_ROUTINE int rtems_cbs_attach_thread (rtems_cbs_server_id
													  server_id,
													  rtems_id task_id)
	{
 ...
 * @return status code.
 */
	RTEMS_INLINE_ROUTINE int rtems_cbs_detach_thread (rtems_cbs_server_id
													  server_id,
													  rtems_id task_id)
	{
 ...
 * @return status code.
 */
	RTEMS_INLINE_ROUTINE int rtems_cbs_destroy_server (rtems_cbs_server_id
													   server_id)
	{
 ...
 * @return status code.
 */
	RTEMS_INLINE_ROUTINE int rtems_cbs_get_parameters (rtems_cbs_server_id
													   server_id,
 ...
 * @return status code.
 */
	RTEMS_INLINE_ROUTINE int rtems_cbs_set_parameters (rtems_cbs_server_id
													   server_id,
													   rtems_cbs_parameters *
													   params)
	{
 ...
 * @return status code.
 */
	RTEMS_INLINE_ROUTINE int rtems_cbs_get_execution_time (rtems_cbs_server_id
														   server_id,
														   time_t * exec_time,
														   time_t * abs_time)
	{
		return _Scheduler_CBS_Get_execution_time (server_id, exec_time,
												  abs_time);
	}
 ...
 * @return status code.
 */
	RTEMS_INLINE_ROUTINE int rtems_cbs_get_remaining_budget (rtems_cbs_server_id
															 server_id,
															 time_t *
															 remaining_budget)
	{
		return _Scheduler_CBS_Get_remaining_budget (server_id,
													remaining_budget);
	}
 ...
 * @return status code.
 */
	RTEMS_INLINE_ROUTINE int rtems_cbs_get_approved_budget (rtems_cbs_server_id
															server_id,
															time_t *
															appr_budget)
	{

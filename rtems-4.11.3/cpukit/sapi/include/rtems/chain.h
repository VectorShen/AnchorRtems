 ...
 */
	rtems_status_code rtems_chain_append_with_notification (rtems_chain_control
															* chain,
															rtems_chain_node *
															node, rtems_id task,
															rtems_event_set
 ...
 * @retval RTEMS_INVALID_ID No such task.
 */
	rtems_status_code rtems_chain_prepend_with_notification (rtems_chain_control
															 * chain,
															 rtems_chain_node *
															 node,
															 rtems_id task,
 ...
 * @retval RTEMS_INVALID_ID No such task.
 */
	rtems_status_code rtems_chain_get_with_notification (rtems_chain_control *
														 chain, rtems_id task,
 ...
 */
	RTEMS_INLINE_ROUTINE void rtems_chain_initialize (rtems_chain_control *
													  the_chain,
													  void *starting_address,
													  size_t number_nodes,
													  size_t node_size)
	{
		_Chain_Initialize (the_chain,
 ...
 */
	RTEMS_INLINE_ROUTINE void rtems_chain_initialize_empty (rtems_chain_control
															* the_chain)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE void rtems_chain_set_off_chain (rtems_chain_node *
														 node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE bool rtems_chain_is_node_off_chain (const
															 rtems_chain_node *
															 node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE bool rtems_chain_is_null_node (const rtems_chain_node *
														the_node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE rtems_chain_node *rtems_chain_head (rtems_chain_control
															 * the_chain)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE const rtems_chain_node
		*rtems_chain_immutable_head (const rtems_chain_control * the_chain)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE rtems_chain_node *rtems_chain_tail (rtems_chain_control
															 * the_chain)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE const rtems_chain_node
		*rtems_chain_immutable_tail (const rtems_chain_control * the_chain)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE rtems_chain_node
		*rtems_chain_first (rtems_chain_control * the_chain)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE const rtems_chain_node
		*rtems_chain_immutable_first (const rtems_chain_control * the_chain)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE rtems_chain_node *rtems_chain_last (rtems_chain_control
															 * the_chain)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE const rtems_chain_node
		*rtems_chain_immutable_last (const rtems_chain_control * the_chain)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE rtems_chain_node *rtems_chain_next (rtems_chain_node *
															 the_node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE const rtems_chain_node
		*rtems_chain_immutable_next (const rtems_chain_node * the_node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE rtems_chain_node
		*rtems_chain_previous (rtems_chain_node * the_node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE const rtems_chain_node
		*rtems_chain_immutable_previous (const rtems_chain_node * the_node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE bool rtems_chain_are_nodes_equal (const
														   rtems_chain_node *
														   left,
														   const
														   rtems_chain_node *
 ...
 */
	RTEMS_INLINE_ROUTINE bool rtems_chain_is_empty (const rtems_chain_control *
													the_chain)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE bool rtems_chain_is_first (const rtems_chain_node *
													the_node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE bool rtems_chain_is_last (const rtems_chain_node *
												   the_node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE bool rtems_chain_has_only_one_node (const
															 rtems_chain_control
															 * the_chain)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE bool rtems_chain_is_head (const rtems_chain_control *
												   the_chain,
												   const rtems_chain_node *
												   the_node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE bool rtems_chain_is_tail (const rtems_chain_control *
												   the_chain,
												   const rtems_chain_node *
												   the_node)
	{
 ...
 * append operation.
 */
	RTEMS_INLINE_ROUTINE void rtems_chain_extract_unprotected (rtems_chain_node
															   * the_node)
	{
...
#else
	RTEMS_INLINE_ROUTINE rtems_chain_node *rtems_chain_get (rtems_chain_control
															* the_chain)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE rtems_chain_node
		*rtems_chain_get_unprotected (rtems_chain_control * the_chain)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE void rtems_chain_insert_unprotected (rtems_chain_node *
															  after_node,
															  rtems_chain_node *
															  the_node)
	{
 ...
 */
	...
	void rtems_chain_append (rtems_chain_control * the_chain,
							 rtems_chain_node * the_node);
#else
	RTEMS_INLINE_ROUTINE void rtems_chain_append (rtems_chain_control *
												  the_chain,
												  rtems_chain_node * the_node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE void
		rtems_chain_append_unprotected (rtems_chain_control * the_chain,
										rtems_chain_node * the_node)
	{
 ...
 */
	...
	void rtems_chain_prepend (rtems_chain_control * the_chain,
							  rtems_chain_node * the_node);
#else
	RTEMS_INLINE_ROUTINE void rtems_chain_prepend (rtems_chain_control *
												   the_chain,
												   rtems_chain_node * the_node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE void
		rtems_chain_prepend_unprotected (rtems_chain_control * the_chain,
										 rtems_chain_node * the_node)
	{
 ...
 */
	...
	RTEMS_INLINE_ROUTINE bool
		rtems_chain_append_with_empty_check (rtems_chain_control * chain,
											 rtems_chain_node * node)
	{
...
#else
	RTEMS_INLINE_ROUTINE bool
		rtems_chain_prepend_with_empty_check (rtems_chain_control * chain,
											  rtems_chain_node * node)
	{
...
#else
	RTEMS_INLINE_ROUTINE bool
		rtems_chain_get_with_empty_check (rtems_chain_control * chain,
										  rtems_chain_node ** node)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE size_t rtems_chain_node_count_unprotected (const
																	rtems_chain_control
																	* chain)
	{

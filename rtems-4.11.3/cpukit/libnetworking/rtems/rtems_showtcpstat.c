 ...
 */
static void showtcpstat (const char *name, unsigned long n)
{
	if (n)
		printf ("%35s%12lu\n", name, n);
}
...
void rtems_bsdnet_show_tcp_stats (void)
{
	...
	showtcpstat ("packets with some duplicate data",
				 tcpstat.tcps_rcvpartduppack);
	showtcpstat ("dup. bytes in part-dup. packets",
	...
	showtcpstat ("packets with data after window",
	...
	showtcpstat ("times ssthresh initialized from rt",

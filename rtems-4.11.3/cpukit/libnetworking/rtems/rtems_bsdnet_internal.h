...
#define	M_NOWAIT	0x0001
	...
	int rtems_bsdnet_parse_driver_name (const struct rtems_bsdnet_ifconfig
										*config, char **namep);
...
/* As rtems_bsdnet_newproc() but with ability to set CPU affinity too */
	rtems_id rtems_bsdnet_newproc_affinity (char *name,
											int stacksize,
											void (*entry) (void *),
											void *arg,
											const cpu_set_t * set,
	...
	static inline rtems_status_code rtems_bsdnet_event_send (rtems_id task_id,
															 rtems_event_set
															 event_in)
	{

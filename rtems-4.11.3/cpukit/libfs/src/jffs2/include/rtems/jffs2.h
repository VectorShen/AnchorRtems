 ...
 */
	typedef int (*rtems_jffs2_flash_read) (rtems_jffs2_flash_control * self,
										   uint32_t offset,
										   unsigned char *buffer,
										   size_t size_of_buffer);
 ...
 * @retval other All other values are reserved and must not be used.
 */
	typedef int (*rtems_jffs2_flash_write) (rtems_jffs2_flash_control * self,
											uint32_t offset,
											const unsigned char *buffer,
											size_t size_of_buffer);
 ...
 * @retval other All other values are reserved and must not be used.
 */
	typedef int (*rtems_jffs2_flash_erase) (rtems_jffs2_flash_control * self,
											uint32_t offset);
 ...
 * @param[in, out] self The flash control.
 */
	typedef void (*rtems_jffs2_flash_destroy) (rtems_jffs2_flash_control *
											   self);
 ...
 */
	typedef
		uint16_t (*rtems_jffs2_compressor_compress)
		(rtems_jffs2_compressor_control * self, unsigned char *data_in,
		 unsigned char *cdata_out, uint32_t * datalen, uint32_t * cdatalen);
 ...
 */
	typedef
		int (*rtems_jffs2_compressor_decompress) (rtems_jffs2_compressor_control
												  * self, uint16_t comprtype,
 ...
 */
	typedef
		void (*rtems_jffs2_compressor_destroy) (rtems_jffs2_compressor_control *
												self);
 ...
 */
	uint16_t
		rtems_jffs2_compressor_rtime_compress (rtems_jffs2_compressor_control *
											   self, unsigned char *data_in,
 ...
 */
	int rtems_jffs2_compressor_rtime_decompress (rtems_jffs2_compressor_control
												 * self, uint16_t comprtype,
												 unsigned char *cdata_in,
												 unsigned char *data_out,
												 uint32_t cdatalen,
 ...
 */
	uint16_t
		rtems_jffs2_compressor_zlib_compress (rtems_jffs2_compressor_control *
											  self, unsigned char *data_in,
											  unsigned char *cdata_out,
											  uint32_t * datalen,
											  uint32_t * cdatalen);
 ...
 */
	int rtems_jffs2_compressor_zlib_decompress (rtems_jffs2_compressor_control *
												self, uint16_t comprtype,
												unsigned char *cdata_in,
												unsigned char *data_out,
												uint32_t cdatalen,

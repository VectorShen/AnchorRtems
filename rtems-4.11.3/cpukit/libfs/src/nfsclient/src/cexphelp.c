...
"   hostspec: [uid.gid@]hostname_or_ipaddr\n", int, nfsMount, (char *hostspec, char *exportdir,
									 char *mntpoint)),
HELP ("Print all currently mounted NFS directories to open file handle.\n" "Pass f = 0 to print to stdout\n",
int, nfsMountsShow, (FILE * f)), CEXP_HELP_TAB_END

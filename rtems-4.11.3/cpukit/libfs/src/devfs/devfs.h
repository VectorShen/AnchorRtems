...
*/
static inline const devFS_data *devFS_get_data (const
...
*  @brief Evaluate Path
*/
extern void devFS_eval_path (rtems_filesystem_eval_path_context_t * ctx);
...
*/
extern int devFS_open (rtems_libio_t * iop,
...
*/
extern int devFS_close (rtems_libio_t * iop);
...
*/
extern ssize_t devFS_read (rtems_libio_t * iop, void *buffer, size_t count);
...
*  it returns -1 and errno is set to proper value.
*/
extern ssize_t devFS_write (rtems_libio_t * iop,
...
*  it returns -1 and errno is set to proper value.
*/
extern int devFS_ioctl (rtems_libio_t * iop,
...
*  it returns -1 and errno is set to proper value.
*/
extern int devFS_stat (const rtems_filesystem_location_info_t * loc,
					   struct stat *buf);
...
*/
extern int devFS_mknod (const rtems_filesystem_location_info_t * parentloc,
						const char *name,
...
*/
extern int devFS_initialize (rtems_filesystem_mount_table_entry_t *

 ...
 */
	extern ssize_t pipe_read (pipe_control_t * pipe,
 ...
 */
	extern ssize_t pipe_write (pipe_control_t * pipe,
							   const void *buffer,
							   size_t count, rtems_libio_t * iop);
 ...
 */
	extern int pipe_ioctl (pipe_control_t * pipe,
						   ioctl_command_t cmd,
						   void *buffer, rtems_libio_t * iop);

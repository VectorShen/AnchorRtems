...
rtems_rfs_pos
rtems_rfs_block_get_pos (rtems_rfs_file_system * fs, rtems_rfs_block_pos * bpos)
{
...
rtems_rfs_block_get_block_size (rtems_rfs_file_system * fs,
								rtems_rfs_pos pos, rtems_rfs_block_size * size)
{
	if (pos == 0)
...
rtems_rfs_block_map_indirect_alloc (rtems_rfs_file_system * fs,
									rtems_rfs_block_map * map,
									rtems_rfs_buffer_handle * buffer,
									rtems_rfs_block_no * block, bool upping)
{

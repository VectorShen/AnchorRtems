...
*/
typedef int (*rtems_dosfs_utf8_to_codepage) (rtems_dosfs_convert_control *
											 self, const uint8_t * src,
...
* @retval ENOMEM Conversion failed (possibly due to insufficient buffer size).
*/
typedef int (*rtems_dosfs_codepage_to_utf8) (rtems_dosfs_convert_control *
											 self, const char *src,
...
* @retval ENOMEM Conversion failed (possibly due to insufficient buffer size).
*/
typedef int (*rtems_dosfs_utf8_to_utf16) (rtems_dosfs_convert_control *
										  self, const uint8_t * src,
...
* @retval ENOMEM Conversion failed (possibly due to insufficient buffer size).
*/
typedef int (*rtems_dosfs_utf16_to_utf8) (rtems_dosfs_convert_control *
										  self, const uint16_t * src,
										  size_t src_size, uint8_t * dst,
										  size_t * dst_size);
...
*/
typedef
	int (*rtems_dosfs_utf8_normalize_and_fold) (rtems_dosfs_convert_control
												* self, const uint8_t * src,
												size_t src_size,
												uint8_t * dst,
												size_t * dst_size);
...
*/
typedef void (*rtems_dosfs_convert_destroy) (rtems_dosfs_convert_control *
											 self);
...
* @retval other Pointer to initialized converter.
*/
rtems_dosfs_convert_control *rtems_dosfs_create_utf8_converter (const char
																*codepage);

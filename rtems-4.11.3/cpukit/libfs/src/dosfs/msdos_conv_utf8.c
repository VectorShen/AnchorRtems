										...
										void *dst, size_t * dst_size)
{
	...
	iconv_status = iconv (desc, &inbuf, &inbytes_left, &outbuf, &outbytes_left);
...
static int msdos_utf8_codepage_to_utf8 (rtems_dosfs_convert_control * super,
										const char *src,
										size_t src_size,
...
static void msdos_utf8_destroy (rtems_dosfs_convert_control * super)
{
	msdos_utf8_convert_control *self = (msdos_utf8_convert_control *) super;
	int rv;

...
*/
static inline void rtems_rtl_ptr_set (rtems_rtl_ptr_t * handle,
									  void *pointer)
{
...
*/
static inline void rtems_rtl_ptr_move (rtems_rtl_ptr_t * dst,
									   rtems_rtl_ptr_t * src)
{
	/*
...
* @param pointer The pointer to set in the handle.
*/
static inline void rtems_rtl_sptr_set (rtems_rtl_sptr_t * handle,
									   void *pointer)
{
...
* @param dst The destination handle to receive the pointer.
*/
static inline void rtems_rtl_sptr_move (rtems_rtl_sptr_t * dst,
										rtems_rtl_sptr_t * src)
{
...
*/
static inline void rtems_rtl_sptr_set_size (rtems_rtl_sptr_t * handle,
											size_t size)
{
	handle->size = size;
}

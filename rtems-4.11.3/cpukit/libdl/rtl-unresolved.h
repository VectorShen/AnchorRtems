...
{
	rtems_rtl_unresolved_empty = 0,
							   /**< The records is empty. Must always be 0 */
	rtems_rtl_unresolved_name = 1,
							   /**< The record is a name. */
	rtems_rtl_unresolved_reloc = 2
...
*/
typedef bool rtems_rtl_unresolved_iterator_t (rtems_rtl_unresolv_rec_t *
											  rec, void *data);
...
*/
bool rtems_rtl_unresolved_interate (rtems_rtl_unresolved_iterator_t
									iterator, void *data);

													 ...
													 new_priority, void *arg)
{
	...
	return !_Thread_Owns_resources (the_thread) &&
		_Thread_Priority_less_than (the_thread->current_priority,
									*new_priority);
}
 ...
 */
void _POSIX_Threads_Sporadic_budget_TSR (Objects_Id id __attribute__ ((unused)),
										 void *argument)
{
	uint32_t ticks;
...
void _POSIX_Threads_Manager_initialization (void)
{
	...
	_Objects_Initialize_information (&_POSIX_Threads_Information,	/* object information table */

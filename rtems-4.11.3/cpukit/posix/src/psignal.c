 ...
 */
RTEMS_STATIC_ASSERT (sizeof (_POSIX_signals_Vectors) ==
					 sizeof (_POSIX_signals_Default_vectors),
...
void _POSIX_signals_Manager_Initialization (void)
{
	...
	memcpy (_POSIX_signals_Vectors,
			_POSIX_signals_Default_vectors, sizeof (_POSIX_signals_Vectors));

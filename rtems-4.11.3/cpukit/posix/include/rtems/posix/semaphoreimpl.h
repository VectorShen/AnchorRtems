...
*/
RTEMS_INLINE_ROUTINE void _POSIX_Semaphore_Free (POSIX_Semaphore_Control *
												 the_semaphore)
{
...
*/
RTEMS_INLINE_ROUTINE POSIX_Semaphore_Control *_POSIX_Semaphore_Get (sem_t *
																	id,
																	Objects_Locations
																	*
																	location)
{
	return (POSIX_Semaphore_Control *)
		_Objects_Get (&_POSIX_Semaphore_Information, (Objects_Id) * id,
					  location);
}

RTEMS_INLINE_ROUTINE POSIX_Semaphore_Control
	*_POSIX_Semaphore_Get_interrupt_disable (sem_t * id,
											 Objects_Locations * location,
											 ISR_lock_Context *
											 lock_context)
{
	return (POSIX_Semaphore_Control *)
		_Objects_Get_isr_disable (&_POSIX_Semaphore_Information,
...
RTEMS_INLINE_ROUTINE void
	_POSIX_Semaphore_Namespace_remove (POSIX_Semaphore_Control *
									   the_semaphore)
{
	_Objects_Namespace_remove (&_POSIX_Semaphore_Information,

...
*/
int _POSIX_Barrier_Translate_core_barrier_return_code (CORE_barrier_Status
													   the_barrier_status);
...
*/
RTEMS_INLINE_ROUTINE void _POSIX_Barrier_Free (POSIX_Barrier_Control *
											   the_barrier)
{
...
*/
RTEMS_INLINE_ROUTINE POSIX_Barrier_Control
	*_POSIX_Barrier_Get (pthread_barrier_t * barrier,
						 Objects_Locations * location)
{
	return (POSIX_Barrier_Control *)
		_Objects_Get (&_POSIX_Barrier_Information, (Objects_Id) * barrier,
					  location);
}

...
RTEMS_INLINE_ROUTINE POSIX_Mutex_Control *_POSIX_Mutex_Allocate (void)
{
	return (POSIX_Mutex_Control *)
		_Objects_Allocate (&_POSIX_Mutex_Information);
}
...
*/
RTEMS_INLINE_ROUTINE void _POSIX_Mutex_Free (POSIX_Mutex_Control *
											 the_mutex)
{
...
RTEMS_INLINE_ROUTINE int
	_POSIX_Mutex_Translate_core_mutex_return_code (CORE_mutex_Status
												   the_mutex_status)
{
	/*
...
*/
POSIX_Mutex_Control *_POSIX_Mutex_Get_interrupt_disable (pthread_mutex_t *
														 mutex,
														 Objects_Locations *
														 location,
														 ISR_lock_Context *

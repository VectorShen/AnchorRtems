 ...
 */
	RTEMS_INLINE_ROUTINE void _POSIX_Spinlock_Free (POSIX_Spinlock_Control *
													the_spinlock)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE POSIX_Spinlock_Control
		*_POSIX_Spinlock_Get (pthread_spinlock_t * spinlock,
							  Objects_Locations * location)
	{
		return (POSIX_Spinlock_Control *)
			_Objects_Get (&_POSIX_Spinlock_Information, (Objects_Id) * spinlock,
						  location);
	}

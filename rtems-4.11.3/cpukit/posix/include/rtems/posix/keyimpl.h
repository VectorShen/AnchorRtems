 ...
 */
	RBTree_Compare_result _POSIX_Keys_Key_value_compare (const RBTree_Node *
														 node1,
														 const RBTree_Node *
														 node2);
 ...
 */
	...
	RTEMS_INLINE_ROUTINE POSIX_Keys_Control *_POSIX_Keys_Allocate (void)
	{
		return (POSIX_Keys_Control *)
			_Objects_Allocate (&_POSIX_Keys_Information);
	}
 ...
 */
	...
	RTEMS_INLINE_ROUTINE void
		_POSIX_Keys_Key_value_pair_free (POSIX_Keys_Key_value_pair *
										 key_value_pair)
	{
		_Freechain_Put (&_POSIX_Keys_Keypool, key_value_pair);
	}

	RTEMS_INLINE_ROUTINE RBTree_Node *_POSIX_Keys_Find (pthread_key_t key,

...
*/
RTEMS_INLINE_ROUTINE void _POSIX_Threads_Copy_attributes (pthread_attr_t *
														  dst_attr,
														  const
														  pthread_attr_t *
														  src_attr);
...
*/
RTEMS_INLINE_ROUTINE void _POSIX_Threads_Free (Thread_Control *
											   the_pthread);
...
RTEMS_INLINE_ROUTINE void
	_POSIX_Threads_Initialize_attributes (pthread_attr_t * attr);
...
*/
int rtems_pthread_attribute_compare (const pthread_attr_t * attr1,
														  ...
														  src_attr)
{
	*dst_attr = *src_attr;
	...
	_Assert (dst_attr->affinitysetsize ==
...
RTEMS_INLINE_ROUTINE void
	_POSIX_Threads_Initialize_attributes (pthread_attr_t * attr)
{
	_POSIX_Threads_Copy_attributes (attr,
...
RTEMS_INLINE_ROUTINE bool _POSIX_Threads_Is_null (Thread_Control *
												  the_pthread)
{
	return !the_pthread;
}

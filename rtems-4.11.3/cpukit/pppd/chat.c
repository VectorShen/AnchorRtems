...
char *abort_string[MAX_ABORTS] =
	{ "BUSY", "NO DIALTONE", "NO CARRIER", "NO ANSWER", "RING\r\nRING" };
int n_aborts = 5;
 ...
 */
static char *clean (char *s, int sending)	/* set to 1 when sending (putting) this string. */
{
 ...
 */
static int get_string (char *in_string)
{
	int c, len, minlen;

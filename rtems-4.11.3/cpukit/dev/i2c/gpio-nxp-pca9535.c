...
static int gpio_nxp_pca9535_get_reg (i2c_dev * dev,
									 gpio_nxp_pca9535_port port, uint16_t * val)
{
	uint8_t out[1] = { port };
...
static int gpio_nxp_pca9535_set_reg (i2c_dev * dev,
									 gpio_nxp_pca9535_port port, uint16_t val)
{
...
static int gpio_nxp_pca9535_ioctl (i2c_dev * dev,
								 ioctl_command_t command, void *arg)
{
	...
	switch (command)
	{
		case GPIO_NXP_PCA9535_GET_INPUT:
			err =
				gpio_nxp_pca9535_get_reg (dev, GPIO_NXP_PCA9535_INPUT_PORT_0,
											arg);
			break;
		case GPIO_NXP_PCA9535_GET_OUTPUT:
			err =
				gpio_nxp_pca9535_get_reg (dev, GPIO_NXP_PCA9535_OUTPUT_PORT_0,
											arg);
			break;
		...
		case GPIO_NXP_PCA9535_SET_OUTPUT:
			err =
				gpio_nxp_pca9535_set_reg (dev, GPIO_NXP_PCA9535_OUTPUT_PORT_0,
											v16);
			break;
		case GPIO_NXP_PCA9535_GET_POL_INV:
			err =
				gpio_nxp_pca9535_get_reg (dev,
											GPIO_NXP_PCA9535_POL_INV_PORT_0,
											arg);
			break;
		...
		case GPIO_NXP_PCA9535_GET_CONFIG:
			err =
				gpio_nxp_pca9535_get_reg (dev, GPIO_NXP_PCA9535_CONF_PORT_0,
											arg);
			break;
		case GPIO_NXP_PCA9535_SET_CONFIG:
			err =
				gpio_nxp_pca9535_set_reg (dev, GPIO_NXP_PCA9535_CONF_PORT_0,
											v16);
			break;
		default:
			err = -ENOTTY;
...
int i2c_dev_register_gpio_nxp_pca9535 (const char *bus_path,
									 const char *dev_path, uint16_t address)
{
	i2c_dev *dev;

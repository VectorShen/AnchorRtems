...
RTEMS_INLINE_ROUTINE void
	rtems_termios_device_context_initialize (rtems_termios_device_context *
...
*/
	bool (*first_open) (struct rtems_termios_tty * tty,
...
*   support legacy drivers.  It must not be used by new drivers.
*/
	void (*last_close) (struct rtems_termios_tty * tty,
						rtems_termios_device_context * context,
						rtems_libio_open_close_args_t * args);
...
*/
	void (*write) (rtems_termios_device_context * context,
...
*/
	bool (*set_attributes) (rtems_termios_device_context * context,
...
typedef struct rtems_termios_tty
{
	...
	enum
	{ rob_idle, rob_busy, rob_wait } rawOutBufState;
...
* @see rtems_termios_device_install().
*/
rtems_status_code rtems_termios_device_open (rtems_device_major_number
											 major,
											 rtems_device_minor_number
											 minor, void *arg);
...
* @param[in] tty The Termios control.
*/
RTEMS_INLINE_ROUTINE void *rtems_termios_get_device_context (const
															 rtems_termios_tty
															 * tty)
{
...
*/
RTEMS_INLINE_ROUTINE void
	rtems_termios_device_lock_acquire (rtems_termios_device_context *
									 context,
...
*/
RTEMS_INLINE_ROUTINE void
	rtems_termios_device_lock_release (rtems_termios_device_context *
									 context,
									 rtems_interrupt_lock_context *
									 lock_context)
{
...
struct rtems_termios_linesw
{
	...
	int (*l_read) (struct rtems_termios_tty * tp,
				 rtems_libio_rw_args_t * args);
	int (*l_write) (struct rtems_termios_tty * tp,
					rtems_libio_rw_args_t * args);
	int (*l_rint) (int c, struct rtems_termios_tty * tp);
	int (*l_start) (struct rtems_termios_tty * tp);
	int (*l_ioctl) (struct rtems_termios_tty * tp,
...
void rtems_termios_puts (const void *buf,
						 size_t len, struct rtems_termios_tty *tty);

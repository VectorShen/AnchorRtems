...
*/
typedef void (*rtems_filesystem_mt_entry_lock_t) (const
...
*/
typedef void (*rtems_filesystem_mt_entry_unlock_t) (const
													rtems_filesystem_mount_table_entry_t
													* mt_entry);
...
*/
typedef
	void (*rtems_filesystem_eval_path_t)
...
*/
typedef int (*rtems_filesystem_link_t) (const
										rtems_filesystem_location_info_t *
										parentloc,
										const
										rtems_filesystem_location_info_t *
										targetloc, const char *name,
										size_t namelen);
...
*/
typedef int (*rtems_filesystem_fchmod_t) (const
										rtems_filesystem_location_info_t *
										loc, mode_t mode);
...
*/
typedef int (*rtems_filesystem_chown_t) (const
										 rtems_filesystem_location_info_t *
										 loc, uid_t owner, gid_t group);
...
*/
typedef
	int (*rtems_filesystem_clonenode_t) (rtems_filesystem_location_info_t *
										 loc);
...
*/
typedef void (*rtems_filesystem_freenode_t) (const
											 rtems_filesystem_location_info_t
											 * loc);
...
*/
typedef
	int (*rtems_filesystem_mount_t) (rtems_filesystem_mount_table_entry_t *
									 mt_entry);
...
*/
typedef
	int (*rtems_filesystem_fsmount_me_t)
...
*/
typedef
	int (*rtems_filesystem_unmount_t) (rtems_filesystem_mount_table_entry_t
									 * mt_entry);
...
*/
typedef
	void (*rtems_filesystem_fsunmount_me_t)
...
*/
typedef bool (*rtems_filesystem_are_nodes_equal_t) (const
													rtems_filesystem_location_info_t
													* a,
													const
													rtems_filesystem_location_info_t
...
*/
typedef int (*rtems_filesystem_mknod_t) (const
										 rtems_filesystem_location_info_t *
										 parentloc, const char *name,
										 size_t namelen, mode_t mode,
										 dev_t dev);
...
*/
typedef int (*rtems_filesystem_rmnod_t) (const
										 rtems_filesystem_location_info_t *
										 parentloc,
										 const
										 rtems_filesystem_location_info_t *
...
*/
typedef int (*rtems_filesystem_utime_t) (const
										 rtems_filesystem_location_info_t *
										 loc, time_t actime,
										 time_t modtime);
...
*/
typedef int (*rtems_filesystem_symlink_t) (const
										 rtems_filesystem_location_info_t
										 * parentloc, const char *name,
										 size_t namelen,
										 const char *target);
...
*/
typedef ssize_t (*rtems_filesystem_readlink_t) (const
												rtems_filesystem_location_info_t
												* loc, char *buf,
												size_t bufsize);
...
*/
typedef int (*rtems_filesystem_rename_t) (const
										rtems_filesystem_location_info_t *
										oldparentloc,
										const
										rtems_filesystem_location_info_t *
...
*/
typedef int (*rtems_filesystem_statvfs_t) (const
										 rtems_filesystem_location_info_t
										 * loc, struct statvfs * buf);
...
*/
void rtems_filesystem_default_lock (const
									rtems_filesystem_mount_table_entry_t *
									mt_entry);
...
*/
void rtems_filesystem_default_unlock (const
									rtems_filesystem_mount_table_entry_t *
									mt_entry);
...
*/
int rtems_filesystem_default_link (const rtems_filesystem_location_info_t *
								 parentloc,
...
*/
bool rtems_filesystem_default_are_nodes_equal (const
											 rtems_filesystem_location_info_t
											 * a,
											 const
											 rtems_filesystem_location_info_t
...
*/
int rtems_filesystem_default_mknod (const rtems_filesystem_location_info_t *
									parentloc, const char *name,
									size_t namelen, mode_t mode, dev_t dev);
...
*/
int rtems_filesystem_default_rmnod (const rtems_filesystem_location_info_t *
									parentloc,
									const rtems_filesystem_location_info_t *
									loc);
...
*/
int rtems_filesystem_default_fchmod (const rtems_filesystem_location_info_t
									 * loc, mode_t mode);
...
*/
int rtems_filesystem_default_chown (const rtems_filesystem_location_info_t *
									loc, uid_t owner, gid_t group);
...
*/
int rtems_filesystem_default_clonenode (rtems_filesystem_location_info_t *
										loc);

/**
* @see rtems_filesystem_freenode_t.
*/
void rtems_filesystem_default_freenode (const
										rtems_filesystem_location_info_t *
										loc);
...
*/
int rtems_filesystem_default_mount (rtems_filesystem_mount_table_entry_t * mt_entry	/* IN */
	);
...
*/
int rtems_filesystem_default_unmount (rtems_filesystem_mount_table_entry_t * mt_entry	/* IN */
	);
...
*/
void rtems_filesystem_default_fsunmount (rtems_filesystem_mount_table_entry_t * mt_entry	/* IN */
	);
...
*/
int rtems_filesystem_default_utime (const rtems_filesystem_location_info_t *
									loc, time_t actime, time_t modtime);
...
*/
int rtems_filesystem_default_symlink (const rtems_filesystem_location_info_t
									* parentloc, const char *name,
									size_t namelen, const char *target);
...
*/
ssize_t rtems_filesystem_default_readlink (const
										 rtems_filesystem_location_info_t
										 * loc, char *buf,
										 size_t bufsize);
...
*/
int rtems_filesystem_default_rename (const rtems_filesystem_location_info_t
									 * oldparentloc,
									 const rtems_filesystem_location_info_t
									 * oldloc,
									 const rtems_filesystem_location_info_t
...
*/
int rtems_filesystem_default_statvfs (const rtems_filesystem_location_info_t
									* loc, struct statvfs *buf);
...
*/
typedef int (*rtems_filesystem_open_t) (rtems_libio_t * iop,
										const char *path,
...
*/
typedef ssize_t (*rtems_filesystem_read_t) (rtems_libio_t * iop,
...
*/
typedef ssize_t (*rtems_filesystem_readv_t) (rtems_libio_t * iop,
...
*/
typedef ssize_t (*rtems_filesystem_write_t) (rtems_libio_t * iop,
											 const void *buffer,
											 size_t count);
...
*/
typedef ssize_t (*rtems_filesystem_writev_t) (rtems_libio_t * iop,
											const struct iovec * iov,
											int iovcnt, ssize_t total);
...
*/
typedef int (*rtems_filesystem_ioctl_t) (rtems_libio_t * iop,
...
*/
typedef off_t (*rtems_filesystem_lseek_t) (rtems_libio_t * iop,
...
*/
typedef int (*rtems_filesystem_fstat_t) (const
										 rtems_filesystem_location_info_t *
										 loc, struct stat * buf);
...
*/
typedef int (*rtems_filesystem_ftruncate_t) (rtems_libio_t * iop,
											 off_t length);
...
*/
typedef int (*rtems_filesystem_kqfilter_t) (rtems_libio_t * iop,
											struct knote * kn);
...
*/
int rtems_filesystem_default_fstat (const rtems_filesystem_location_info_t *
									loc, struct stat *buf);
...
rtems_filesystem_fsmount_me_t
	rtems_filesystem_get_mount_handler (const char *type);
...
typedef int (*rtems_libio_open_t) (const char *pathname,
...
typedef ssize_t (*rtems_libio_write_t) (int fd,
										const void *buffer, size_t count);
...
static inline dev_t rtems_filesystem_make_dev_t (rtems_device_major_number
												 _major,
...
static inline dev_t rtems_filesystem_make_dev_t_from_pointer (const void
															*pointer)
{
	uint64_t temp = (((uint64_t) 1) << 63) | (((uintptr_t) pointer) >> 1);

	return rtems_filesystem_make_dev_t ((uint32_t) (temp >> 32),
										(uint32_t) temp);
}

static inline rtems_device_major_number rtems_filesystem_dev_major_t (dev_t
																	device)
{
	union __rtems_dev_t temp;
...
static inline rtems_device_minor_number rtems_filesystem_dev_minor_t (dev_t
																	device)
{
	union __rtems_dev_t temp;
...
struct rtems_filesystem_mount_table_entry_tt
{
	...
	bool mounted;
	bool writeable;
	const rtems_filesystem_limits_and_options_t
...
int mount (const char *source,
		 ...
		 rtems_filesystem_options_t options, const void *data);
...
*/
typedef bool (*rtems_per_filesystem_routine) (const rtems_filesystem_table_t
											* fs_entry, void *arg);
...
*/
typedef bool (*rtems_filesystem_mt_entry_visitor) (const
												 rtems_filesystem_mount_table_entry_t
												 * mt_entry, void *arg);
...
* @retval false Iteration through all entries.
*/
bool rtems_filesystem_mount_iterate (rtems_filesystem_mt_entry_visitor
									 visitor, void *visitor_arg);
...
*/
rtems_status_code rtems_termios_bufsize (size_t cbufsize,	/* cooked buffer size */
										 size_t raw_input,	/* raw input buffer size */
										 size_t raw_output	/* raw output buffer size */
	);

rtems_status_code rtems_termios_open (rtems_device_major_number major,
									rtems_device_minor_number minor,
									void *arg,
									const rtems_termios_callbacks *
									callbacks);
...
int rtems_termios_enqueue_raw_characters (void *ttyp,

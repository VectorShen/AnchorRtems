...
static bool count_posix_key_value_pairs (const RBTree_Node * node,
...
static uint32_t get_active_posix_key_value_pairs (void)
{
	...
	_RBTree_Iterate (&_POSIX_Keys_Key_value_lookup_tree,
					 RBT_LEFT, count_posix_key_value_pairs, &count);
...
void rtems_resource_snapshot_take (rtems_resource_snapshot * snapshot)
{
	...
	snapshot->active_posix_key_value_pairs =
		get_active_posix_key_value_pairs ();

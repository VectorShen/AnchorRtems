...
int link (const char *path1, const char *path2)
{
	...
	rv = rtems_filesystem_location_exists_in_same_instance_as (currentloc_1,
															 currentloc_2);
	if (rv == 0)
	{
		rv = (*currentloc_2->mt_entry->ops->link_h) (currentloc_2,
													 currentloc_1,
 ...
 */
int _link_r (struct _reent *ptr __attribute__ ((unused)),

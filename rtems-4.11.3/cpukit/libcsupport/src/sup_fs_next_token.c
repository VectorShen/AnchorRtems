...
void
rtems_filesystem_eval_path_eat_delimiter (rtems_filesystem_eval_path_context_t *
										ctx)
{
...
void rtems_filesystem_eval_path_next_token (rtems_filesystem_eval_path_context_t
											* ctx)
{

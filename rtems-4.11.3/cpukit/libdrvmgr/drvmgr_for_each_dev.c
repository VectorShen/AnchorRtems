...
static int
drvmgr_for_each_dev_breadth (int (*func) (struct drvmgr_dev * dev, void *arg),
							 void *arg)
{
	int ret = 0, i, pos;
...
static int
drvmgr_for_each_dev_depth (int (*func) (struct drvmgr_dev * dev, void *arg),
						 void *arg)
{
	int ret = 0;
	struct drvmgr_dev *dev;
...
int drvmgr_for_each_dev (int (*func) (struct drvmgr_dev * dev, void *arg),

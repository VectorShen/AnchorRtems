...
AUTH *authnone_create (void)
{
 ...
 /*ARGSUSED*/ static int authnone_marshal (AUTH * client, XDR * xdrs)
{
	struct authnone_private *ap = authnone_private;
...
static int authnone_validate (AUTH * client, struct opaque_auth *opaque)
{

	return (TRUE);
}

static int authnone_refresh (AUTH * client)
{

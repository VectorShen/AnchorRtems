...
static char *rcsid =
	"$FreeBSD: src/lib/libc/rpc/clnt_udp.c,v 1.15 2000/01/27 23:06:36 jasone Exp $";
#endif
 ...
 * sent and received.
 */
CLIENT *clntudp_bufcreate (struct sockaddr_in *raddr, u_long program,	/* program number */
...
CLIENT *clntudp_create (struct sockaddr_in * raddr, u_long program,	/* program number */
						u_long version,	/* version number */
...
static enum clnt_stat clntudp_call (CLIENT * cl,	/* client handle */

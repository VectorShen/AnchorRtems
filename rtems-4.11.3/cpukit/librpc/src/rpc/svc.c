...
static char *rcsid =
	"$FreeBSD: src/lib/libc/rpc/svc.c,v 1.14 1999/08/28 00:00:48 peter Exp $";
#endif
 ...
 * struct.
 */
static struct svc_callout *svc_find (u_long prog,
									 u_long vers, struct svc_callout **prev)
{
 ...
 */
bool_t
svc_sendreply (register SVCXPRT * xprt,
 ...
 */
void
svcerr_progvers (register SVCXPRT * xprt,

...
__BEGIN_DECLS extern bool_t xdr_des_block (XDR *, des_block *);
__END_DECLS
/*
	...
	typedef struct __rpc_auth
{
	...
	struct auth_ops
	{
		...
		/* validate verifier */
		int (*ah_validate) (struct __rpc_auth *, struct opaque_auth *);
		/* refresh credentials */
...
extern AUTH *authdes_pk_create (char *, netobj *, u_int,
								struct sockaddr *, des_block *, nis_server *);
#endif
__END_DECLS
/*
 ...
 * Publickey routines.
 */
__BEGIN_DECLS extern int getpublickey (char *, char *);

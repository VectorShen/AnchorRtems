 ...
 */
	...
	extern nis_result *nis_make_error (nis_error, u_long, u_long, u_long,
									   u_long);
	...
	extern CLIENT *nis_make_rpchandle (nis_server *, int, u_long, u_long,
									   u_long, int, int);
	...
	extern nis_server *__nis_init_callback (CLIENT *,
											int (*)(nis_name, nis_object *,
													void *), void *);
	extern int nis_getdtblsize (void);
	extern int __nis_run_callback (netobj *, u_long, struct timeval *,
								   CLIENT *);

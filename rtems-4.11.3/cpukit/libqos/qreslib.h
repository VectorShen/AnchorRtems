 ...
 */
	...
	{
		return _Scheduler_CBS_Create_server ((Scheduler_CBS_Parameters *)
											 params, NULL, server_id);
	}
 ...
 */
	...
	{
		return _Scheduler_CBS_Get_parameters (server_id,
 ...
 */
	RTEMS_INLINE_ROUTINE qos_rv qres_set_params (qres_sid_t server_id,
												 qres_params_t * params)
	{
		return _Scheduler_CBS_Set_parameters (server_id,
											  (Scheduler_CBS_Parameters *)
											  params);
	}

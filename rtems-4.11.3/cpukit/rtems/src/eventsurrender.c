...
static void _Event_Satisfy (Thread_Control * the_thread,
							Event_Control * event,
...
static bool _Event_Is_blocking_on_event (const Thread_Control * the_thread,
...
static bool _Event_Is_satisfied (const Thread_Control * the_thread,
								 rtems_event_set pending_events,
								 rtems_event_set * seized_events)
{

...
RTEMS_STATIC_ASSERT (sizeof (RTEMS_tasks_MP_Packet) <=
					 MP_PACKET_MINIMUM_PACKET_SIZE, RTEMS_tasks_MP_Packet);
...
void _RTEMS_tasks_MP_Send_process_packet (RTEMS_tasks_MP_Remote_operations
...
rtems_status_code
_RTEMS_tasks_MP_Send_request_packet (RTEMS_tasks_MP_Remote_operations operation,
									 Objects_Id task_id,
...
void _RTEMS_tasks_MP_Send_response_packet (RTEMS_tasks_MP_Remote_operations
										   operation,
	...
	switch (the_packet->operation)
	  {
		  ...
		  case RTEMS_TASKS_MP_ANNOUNCE_CREATE:
			  ...
			  ignored =
				  _Objects_MP_Allocate_and_open (&_RTEMS_tasks_Information,
												 the_packet->name,
		  ...
		  case RTEMS_TASKS_MP_ANNOUNCE_DELETE:
			  ...
			  _Objects_MP_Close (&_RTEMS_tasks_Information,
		  ...
		  case RTEMS_TASKS_MP_SUSPEND_REQUEST:
			  ...
			  the_packet->Prefix.return_code =
				  rtems_task_suspend (the_packet->Prefix.id);

			  _RTEMS_tasks_MP_Send_response_packet
				  (RTEMS_TASKS_MP_SUSPEND_RESPONSE, _Thread_Executing);
			  break;
		  ...
		  case RTEMS_TASKS_MP_RESUME_REQUEST:
			  ...
			  the_packet->Prefix.return_code =
				  rtems_task_resume (the_packet->Prefix.id);

			  _RTEMS_tasks_MP_Send_response_packet
				  (RTEMS_TASKS_MP_RESUME_RESPONSE, _Thread_Executing);
			  break;

		  case RTEMS_TASKS_MP_SET_PRIORITY_REQUEST:

			  the_packet->Prefix.return_code =
				  rtems_task_set_priority (the_packet->Prefix.id,
										   the_packet->the_priority,
										   &the_packet->the_priority);

			  _RTEMS_tasks_MP_Send_response_packet
				  (RTEMS_TASKS_MP_SET_PRIORITY_RESPONSE, _Thread_Executing);
			  break;
		  ...
		  case RTEMS_TASKS_MP_GET_NOTE_REQUEST:
			  ...
			  the_packet->Prefix.return_code =
				  rtems_task_get_note (the_packet->Prefix.id,
									   the_packet->notepad, &the_packet->note);

			  _RTEMS_tasks_MP_Send_response_packet
				  (RTEMS_TASKS_MP_GET_NOTE_RESPONSE, _Thread_Executing);
			  break;
		  ...
		  case RTEMS_TASKS_MP_SET_NOTE_REQUEST:
			  ...
			  the_packet->Prefix.return_code =
				  rtems_task_set_note (the_packet->Prefix.id,
									   the_packet->notepad, the_packet->note);

			  _RTEMS_tasks_MP_Send_response_packet
				  (RTEMS_TASKS_MP_SET_NOTE_RESPONSE, _Thread_Executing);
			  break;
	  }
}

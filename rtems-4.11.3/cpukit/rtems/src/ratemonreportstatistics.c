		 ...
		 id <= _Rate_monotonic_Information.maximum_id; id++)
	  {
		   ...
		   */
		  {
			  ...
			  (*print) (context, "%" PRId32 "." NANOSECONDS_FMT "/"	/* min cpu time */
						...
						_Timespec_Get_nanoseconds (min_cpu) /
						NANOSECONDS_DIVIDER, _Timespec_Get_seconds (max_cpu),
						_Timespec_Get_nanoseconds (max_cpu) /
						NANOSECONDS_DIVIDER,
		   ...
		   */
		  {
			  ...
			  (*print) (context, "%" PRId32 "." NANOSECONDS_FMT "/"	/* min wall time */
						...
						_Timespec_Get_nanoseconds (min_wall) /
						NANOSECONDS_DIVIDER, _Timespec_Get_seconds (max_wall),
						_Timespec_Get_nanoseconds (max_wall) /
						NANOSECONDS_DIVIDER,

...
{
	_Objects_Initialize_information (&_Region_Information,	/* object information table */
...
#if defined(RTEMS_MULTIPROCESSING)
	_MPCI_Register_packet_processor (MP_PACKET_REGION, 0	/* Multiprocessing is not currently supported for Regions */
		);
#endif

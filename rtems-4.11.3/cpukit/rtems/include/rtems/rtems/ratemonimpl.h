 ...
 *  the inactive chain of free period control blocks.
 */
	RTEMS_INLINE_ROUTINE void _Rate_monotonic_Free (Rate_monotonic_Control *
													the_period)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE Rate_monotonic_Control *_Rate_monotonic_Get (Objects_Id
																	  id,
																	  Objects_Locations
																	  *
																	  location)
 ...
 *  and FALSE otherwise.
 */
	RTEMS_INLINE_ROUTINE bool _Rate_monotonic_Is_active (Rate_monotonic_Control
														 * the_period)
	{
 ...
 */
	RTEMS_INLINE_ROUTINE bool
		_Rate_monotonic_Is_inactive (Rate_monotonic_Control * the_period)
	{
 ...
 *  and FALSE otherwise.
 */
	RTEMS_INLINE_ROUTINE bool _Rate_monotonic_Is_expired (Rate_monotonic_Control
														  * the_period)
	{
 ...
 *  @param[in] the_period points to the period being operated upon.
 */
	void _Rate_monotonic_Initiate_statistics (Rate_monotonic_Control *
											  the_period);

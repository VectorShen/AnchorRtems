...
*/
void rtems_cache_flush_multiple_data_lines_processor_set (const void *addr,
														  size_t size,
														  const size_t
														  setsize,
														  const cpu_set_t *
...
* @param[in] set The target processor set.
*/
void rtems_cache_invalidate_multiple_data_lines_processor_set (const void
															   *addr,
															   size_t size,
															   const size_t
															   setsize,
...
* @param[in] set The target processor set.
*/
void rtems_cache_flush_entire_data_processor_set (const size_t setsize,
												  const cpu_set_t * set);
...
* @param[in] set The target processor set.
*/
void rtems_cache_invalidate_entire_data_processor_set (const size_t setsize,
													   const cpu_set_t *
													   set);

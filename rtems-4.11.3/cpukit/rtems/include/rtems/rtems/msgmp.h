 ...
 */
	void _Message_queue_Core_message_queue_mp_support (Thread_Control *
													   the_thread, rtems_id id);
 ...
 */
	void _Message_queue_MP_Send_process_packet
		(Message_queue_MP_Remote_operations operation,
		 Objects_Id message_queue_id, rtems_name name, Objects_Id proxy_id);
 ...
 */
	rtems_status_code
		...
		(Message_queue_MP_Remote_operations operation,
		 Objects_Id message_queue_id, const void *buffer, size_t * size_p,
		 rtems_option option_set, rtems_interval timeout);
 ...
 */
	void _Message_queue_MP_Send_response_packet
		(Message_queue_MP_Remote_operations operation,
		 Objects_Id message_queue_id, Thread_Control * the_thread);
 ...
 */
	void _Message_queue_MP_Process_packet (rtems_packet_prefix *
										   the_packet_prefix);

...
*/
typedef void (*Timer_server_Method) (Timer_server_Control * timer_server,
									 Timer_Control * timer);
...
RTEMS_INLINE_ROUTINE bool _Timer_Is_interval_class (Timer_Classes the_class)
{
	return (the_class == TIMER_INTERVAL)
		|| (the_class == TIMER_INTERVAL_ON_TASK);
}
...
*  timer, and FALSE otherwise.
*/
RTEMS_INLINE_ROUTINE bool _Timer_Is_timer_of_day_class (Timer_Classes
														the_class)
{

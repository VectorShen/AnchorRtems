...
*         be filled in with the current time of day.
*/
rtems_status_code rtems_clock_get_seconds_since_epoch (rtems_interval *
													   the_interval);
...
*/
RTEMS_INLINE_ROUTINE rtems_interval rtems_clock_tick_later (rtems_interval
															delta)
{
...
*/
RTEMS_INLINE_ROUTINE rtems_interval
	rtems_clock_tick_later_usec (rtems_interval delta_in_usec)
{

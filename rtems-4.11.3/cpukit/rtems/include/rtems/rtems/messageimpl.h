...
*/
rtems_status_code
	_Message_queue_Translate_core_message_queue_return_code (uint32_t
...
*  the inactive chain of free message queue control blocks.
*/
RTEMS_INLINE_ROUTINE void _Message_queue_Free (Message_queue_Control *
											   the_message_queue)
{
...
*/
RTEMS_INLINE_ROUTINE Message_queue_Control *_Message_queue_Get (Objects_Id
																id,
																Objects_Locations
																* location)
{
...
RTEMS_INLINE_ROUTINE Message_queue_Control
	*_Message_queue_Get_interrupt_disable (Objects_Id id,
										   Objects_Locations * location,
										   ISR_lock_Context * lock_context)
{
	return (Message_queue_Control *)
		_Objects_Get_isr_disable (&_Message_queue_Information, id, location,
								  lock_context);
}

...
*/
static inline rtems_capture_control_t *rtems_capture_task_control (rtems_tcb
																 * tcb)
{
...
{
	return _RTEMS_tasks_Priority_from_Core (tcb->Start.initial_priority);
}
...
*/
static inline uint32_t
	rtems_capture_control_all_by_triggers (rtems_capture_control_t *
										 control)
{
...
*/
static inline int
	rtems_capture_control_by_valid (rtems_capture_control_t * control,
									int slot)
{
...
*/
static inline rtems_name
	rtems_capture_control_by_name (rtems_capture_control_t * control,
								 int by)
{

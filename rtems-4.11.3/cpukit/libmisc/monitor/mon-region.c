...
void
rtems_monitor_region_canonical (rtems_monitor_region_t * canonical_region,
...
void rtems_monitor_region_dump_header (bool verbose __attribute__ ((unused)))
{
	printf ("\
...
void
rtems_monitor_region_dump (rtems_monitor_region_t * monitor_region,

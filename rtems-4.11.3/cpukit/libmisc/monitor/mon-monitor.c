...
rtems_status_code rtems_monitor_suspend (rtems_interval timeout)
{
	...
	status = rtems_event_receive (MONITOR_WAKEUP_EVENT,
								RTEMS_DEFAULT_OPTIONS, timeout, &event_set);
	return status;
}

void __attribute__ ((weak))
rtems_monitor_reset_cmd (int argc,
						 char **argv,
...
void rtems_monitor_debugger_cmd (int argc __attribute__ ((unused)),
...
void rtems_monitor_pause_cmd (int argc,
							char **argv,
							const rtems_monitor_command_arg_t * command_arg
							__attribute__ ((unused)), bool verbose
							__attribute__ ((unused)))
...
void rtems_monitor_fatal_cmd (int argc,
							char **argv,
							const rtems_monitor_command_arg_t * command_arg,
...
void rtems_monitor_continue_cmd (int argc __attribute__ ((unused)),
								 char **argv __attribute__ ((unused)),
								 const rtems_monitor_command_arg_t * command_arg
								 __attribute__ ((unused)), bool verbose
								 __attribute__ ((unused)))
...
#if defined(RTEMS_MULTIPROCESSING)
void rtems_monitor_node_cmd (int argc,
							 char **argv,
							 const rtems_monitor_command_arg_t * command_arg
							 __attribute__ ((unused)), bool verbose
							 __attribute__ ((unused)))

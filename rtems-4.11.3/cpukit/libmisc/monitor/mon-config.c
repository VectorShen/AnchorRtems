...
void
rtems_monitor_config_canonical (rtems_monitor_config_t * canonical_config,
...
void rtems_monitor_config_dump_header (bool verbose __attribute__ ((unused)))
{
	fprintf (stdout, "\
						   ...
						   bool verbose __attribute__ ((unused)))
{
	...
	length +=
		fprintf (stdout,
				 "usec/tick: %" PRId32 ";  tick/timeslice: %" PRId32
				 ";  tick/sec: %" PRId32 "\n",
	...
	length +=
		fprintf (stdout,
				 "tasks: %" PRId32 ";  timers: %" PRId32 ";  sems: %" PRId32
				 ";  que's: %" PRId32 ";  ext's: %" PRId32 "\n",
				 monitor_config->maximum_tasks, monitor_config->maximum_timers,
	...
	length +=
		fprintf (stdout,
				 "partitions: %" PRId32 ";  regions: %" PRId32 ";  ports: %"
				 PRId32 ";  periods: %" PRId32 "\n",
				 monitor_config->maximum_partitions,
				 monitor_config->maximum_regions, monitor_config->maximum_ports,

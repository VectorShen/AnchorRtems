...
void
rtems_monitor_symbol_canonical (rtems_monitor_symbol_t * canonical_symbol,
								rtems_symbol_t * sp)
{
...
void
rtems_monitor_symbol_canonical_by_name (rtems_monitor_symbol_t *
										canonical_symbol, const char *name)
{
	rtems_symbol_t *sp;
...
void
rtems_monitor_symbol_canonical_by_value (rtems_monitor_symbol_t *
										 canonical_symbol, void *value_void_p)
{

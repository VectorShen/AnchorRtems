 ...
 */
	...
	typedef void (*rtems_monitor_command_function_t) (int argc,
													  char **argv,
													  const
	...
	typedef const void *(*rtems_monitor_object_next_fn) (void *, void *,
														 rtems_id *);
	...
	typedef bool (*rtems_monitor_per_command_routine) (const
													   rtems_monitor_command_entry_t
													   *, void *);

/* monitor.c */
	void rtems_monitor_pause_cmd (int, char **,
								  const rtems_monitor_command_arg_t *, bool);
	void rtems_monitor_fatal_cmd (int, char **,
								  const rtems_monitor_command_arg_t *, bool);
	void rtems_monitor_continue_cmd (int, char **,
									 const rtems_monitor_command_arg_t *, bool);
	void rtems_monitor_debugger_cmd (int, char **,
									 const rtems_monitor_command_arg_t *, bool);
	void rtems_monitor_reset_cmd (int, char **,
								  const rtems_monitor_command_arg_t *, bool);
	void rtems_monitor_node_cmd (int, char **,
								 const rtems_monitor_command_arg_t *, bool);
	void rtems_monitor_symbols_loadup (void);
	int rtems_monitor_insert_cmd (rtems_monitor_command_entry_t *);
	void rtems_monitor_wakeup (void);
	void rtems_monitor_command_iterate (rtems_monitor_per_command_routine
										routine, void *arg);
...
/* server.c */
	...
	rtems_status_code rtems_monitor_server_request (uint32_t,
													rtems_monitor_server_request_t
													*,
													rtems_monitor_server_response_t
													*);
...
/* command.c */
	...
	void rtems_monitor_command_usage (const rtems_monitor_command_entry_t *,
									  const char *);
	void rtems_monitor_help_cmd (int, char **,
								 const rtems_monitor_command_arg_t *, bool);
	const rtems_monitor_command_entry_t *rtems_monitor_command_lookup (const
																	   char
																	   *name);
...
/* object.c */
	rtems_id rtems_monitor_id_fixup (rtems_id, uint32_t,
									 rtems_monitor_object_type_t);
	const rtems_monitor_object_info_t
		*rtems_monitor_object_lookup (rtems_monitor_object_type_t type);
	rtems_id rtems_monitor_object_canonical_get (rtems_monitor_object_type_t,
												 rtems_id, void *,
												 size_t * size_p);
	rtems_id rtems_monitor_object_canonical_next (const
												  rtems_monitor_object_info_t *,
												  rtems_id, void *);
	const void *rtems_monitor_object_next (void *, void *, rtems_id,
										   rtems_id *);
	rtems_id rtems_monitor_object_canonical (rtems_id, const void *);
	void rtems_monitor_object_cmd (int, char **,
								   const rtems_monitor_command_arg_t *, bool);
...
/* config.c */
	void rtems_monitor_config_canonical (rtems_monitor_config_t *,
										 const void *);
	const void *rtems_monitor_config_next (void *, rtems_monitor_config_t *,
										   rtems_id *);
...
/* mpci.c */
	...
	const void *rtems_monitor_mpci_next (void *, rtems_monitor_mpci_t *,
										 rtems_id *);
...
/* itask.c */
	void rtems_monitor_init_task_canonical (rtems_monitor_init_task_t *,
											const void *);
	const void *rtems_monitor_init_task_next (void *,
											  rtems_monitor_init_task_t *,
											  rtems_id *);
	void rtems_monitor_init_task_dump_header (bool);
	void rtems_monitor_init_task_dump (rtems_monitor_init_task_t *,
									   bool verbose);

/* extension.c */
	void rtems_monitor_extension_canonical (rtems_monitor_extension_t *,
											const void *);
...
/* region.c */
	void rtems_monitor_region_canonical (rtems_monitor_region_t *,
										 const void *);
...
/* driver.c */
	const void *rtems_monitor_driver_next (void *, rtems_monitor_driver_t *,
										   rtems_id *);
	void rtems_monitor_driver_canonical (rtems_monitor_driver_t *,
										 const void *);
...
/* symbols.c */
	...
	rtems_symbol_t *rtems_symbol_create (rtems_symbol_table_t *, const char *,
										 uint32_t);
	...
	const void *rtems_monitor_symbol_next (void *object_info,
										   rtems_monitor_symbol_t *,
										   rtems_id *);
	void rtems_monitor_symbol_canonical (rtems_monitor_symbol_t *,
										 rtems_symbol_t *);
	void rtems_monitor_symbol_canonical_by_name (rtems_monitor_symbol_t *,
												 const char *);
	...
	void rtems_monitor_symbol_cmd (int, char **,
								   const rtems_monitor_command_arg_t *, bool);

#if defined(RTEMS_NETWORKING)
	void mon_ifconfig (int argc,
					   char *argv[], uint32_t command_arg, bool verbose);

...
void
rtems_monitor_part_canonical (rtems_monitor_part_t * canonical_part,
...
void rtems_monitor_part_dump_header (bool verbose __attribute__ ((unused)))
{
	printf ("\
...
void
rtems_monitor_part_dump (rtems_monitor_part_t * monitor_part,

...
rtems_device_driver null_initialize (rtems_device_major_number major,
...
rtems_device_driver null_close (rtems_device_major_number major
								__attribute__ ((unused)),
								rtems_device_minor_number minor
								__attribute__ ((unused)), void *pargp
								__attribute__ ((unused)))
...
rtems_device_driver null_write (rtems_device_major_number major
								__attribute__ ((unused)),
								rtems_device_minor_number minor
								__attribute__ ((unused)), void *pargp)
{

 ...
 * configuration setup.
 */
static int shell_pci_pcfg (int argc,
						   char *argv[], struct shell_pci_modifier *mod)
{
	if (argc != 2)
		return -1;
...
static int shell_pci_ls (int argc, char *argv[], struct shell_pci_modifier *mod)
{
	unsigned long pciid;
...
static int shell_pci_rX (unsigned long pciid, int offset, int size)
{
	uint8_t data8;
	uint16_t data16;
	uint32_t data32;
...
static int shell_pci_wX (unsigned long pciid,
						 int offset, uint32_t data, int size)
{
	uint8_t data8;
	uint16_t data16;
	int result;
...
static int shell_pci_read (int argc,
						   char *argv[], struct shell_pci_modifier *mod)
{
...
static int shell_pci_write (int argc,
							char *argv[], struct shell_pci_modifier *mod)
{
	unsigned long pciid, offset;
	int result, size;
...
static int shell_pci_pciid (int argc,
							char *argv[], struct shell_pci_modifier *mod)
{
	unsigned long pciid;
...
static int shell_pci_getdev (int argc,
							 char *argv[], struct shell_pci_modifier *mod)
{
	unsigned long pciid;
	struct pci_dev *dev;
...
static int shell_pci_infodev (int argc,
							  char *argv[], struct shell_pci_modifier *mod)
{
	unsigned long arg;
	struct pci_dev *dev;
...
static int shell_pci_usage (int argc,
							char *argv[], struct shell_pci_modifier *mod)
{
	usage ();
	return 0;
...
static int rtems_shell_main_pci (int argc, char *argv[])
{
	struct shell_pci_modifier *mod;
	int rc;

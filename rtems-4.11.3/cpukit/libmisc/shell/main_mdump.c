...
static int rtems_shell_main_mdump (int argc, char *argv[])
{
	void *addr;
	int max;
	int sz;
...
static int rtems_shell_main_wdump (int argc, char *argv[])
{
	void *addr;
	int max;
	int sz;
...
static int rtems_shell_main_ldump (int argc, char *argv[])
{
	void *addr;
	int max;
	int sz;
...
int args_parse (int argc, char *argv[], void **addr, int *max, int *sz)
{
	*addr = NULL;
	*max = 320;
	*sz = 1;

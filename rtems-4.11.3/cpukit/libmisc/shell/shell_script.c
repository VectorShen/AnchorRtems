...
{
	printf ("joel [args] where args may be:\n"
...
static int rtems_shell_main_joel (int argc, char **argv)
{
	unsigned long tmp;
	int option;
	int sc;
	 ...
	 * Run the script
	 */
	result = rtems_shell_script (taskName,	/* the name of the task */
 ...
 */
int rtems_shell_script_file (int argc __attribute__ ((unused)), char *argv[])
{

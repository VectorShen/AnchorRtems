 ...
 */
	typedef
		void (*rtems_test_parallel_worker_setup) (rtems_test_parallel_context *
												  ctx, size_t worker_index,
												  rtems_id worker_id);
 ...
 */
   ...
   */
		rtems_interval (*init) (rtems_test_parallel_context * ctx,
   ...
   */
		void (*body) (rtems_test_parallel_context * ctx,
   ...
   *   option.
   */
		void (*fini) (rtems_test_parallel_context * ctx,
					  void *arg, size_t active_workers);
 ...
 */
	static inline bool rtems_test_parallel_stop_job (const
													 rtems_test_parallel_context
													 * ctx)
	{
 ...
 * @retval false Otherwise.
 */
	static inline bool rtems_test_parallel_is_master_worker (size_t
															 worker_index)
	{
 ...
 */
	static inline rtems_id rtems_test_parallel_get_task_id (const
															rtems_test_parallel_context
															* ctx,
															size_t worker_index)
	{

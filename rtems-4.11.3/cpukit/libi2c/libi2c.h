...
extern int rtems_libi2c_register_bus (const char *name,
...
*/
extern int
	rtems_libi2c_register_drv (const char *name,
							   rtems_libi2c_drv_t * drvtbl, unsigned bus,
							   unsigned i2caddr);
...
*/
extern rtems_status_code rtems_libi2c_send_start (rtems_device_minor_number
												  minor);

extern rtems_status_code rtems_libi2c_send_stop (rtems_device_minor_number
												 minor);
...
extern int
	rtems_libi2c_ioctl (rtems_device_minor_number minor, int cmd, ...);
/*

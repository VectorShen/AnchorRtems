...
static inline int
	pci_read_config_byte (unsigned char bus,
						  unsigned char slot,
						  unsigned char function,
						  unsigned char where, uint8_t * val)
{
	return BSP_pci_configuration.pci_functions->read_config_byte (bus, slot,
																  function,
																  where,
																  val);
}
...
static inline int
	pci_read_config_word (unsigned char bus,
						  unsigned char slot,
						  unsigned char function,
						  unsigned char where, uint16_t * val)
{
	return BSP_pci_configuration.pci_functions->read_config_word (bus, slot,
																  function,
																  where,
																  val);
}
...
static inline int
	pci_read_config_dword (unsigned char bus,
						   unsigned char slot,
						   unsigned char function,
						   unsigned char where, uint32_t * val)
{
...
static inline int
	pci_write_config_byte (unsigned char bus,
						   unsigned char slot,
						   unsigned char function,
						   unsigned char where, uint8_t val)
{
	return BSP_pci_configuration.pci_functions->write_config_byte (bus,
																   slot,
																   function,
																   where,
																   val);
...
static inline int
	pci_write_config_word (unsigned char bus,
						   unsigned char slot,
						   unsigned char function,
						   unsigned char where, uint16_t val)
{
	return BSP_pci_configuration.pci_functions->write_config_word (bus,
																   slot,
																   function,
																   where,
																   val);
...
static inline int
	pci_write_config_dword (unsigned char bus,
							unsigned char slot,
							unsigned char function,
							unsigned char where, uint32_t val)
{
	return BSP_pci_configuration.pci_functions->write_config_dword (bus,
																	slot,
																	function,
																	where,
																	val);
...
*/
int pci_find_device (unsigned short vendorid,

...
static inline void rtems_uint16_to_little_endian (uint16_t value,
												uint8_t * data)
{
	int i;
...
static inline void rtems_uint32_to_little_endian (uint32_t value,
												uint8_t * data)
{
	int i;
...
static inline void rtems_uint64_to_little_endian (uint64_t value,
												uint8_t * data)
{
	int i;

 ...
 * conditions.
 */
rtems_status_code rtems_interrupt_handler_install (rtems_vector_number
...
* conditions.
*/
rtems_status_code rtems_interrupt_handler_remove (rtems_vector_number
												  vector,
												  rtems_interrupt_handler
												  handler, void *arg);
...
*/
typedef void (*rtems_interrupt_per_handler_routine) (void *, const char *,
													 rtems_option,
													 rtems_interrupt_handler,
													 void *);
...
* conditions.
*/
rtems_status_code rtems_interrupt_handler_iterate (rtems_vector_number
												   vector,

 ...
 */
int BSP_VMEDmaSetup (int channel, uint32_t bus_mode, uint32_t xfer_mode,
					 void *custom_setup);
 ...
 */
int BSP_VMEDmaStart (int channel, uint32_t pci_addr, uint32_t vme_addr,
					 uint32_t n_bytes);
...
int BSP_VMEDmaInstallISR (int channel, BSP_VMEDmaIRQCallback cb,
						  void *usr_arg);
...
BSP_VMEDmaListDescriptor
	BSP_VMEDmaListDescriptorSetup (BSP_VMEDmaListDescriptor d,
								   uint32_t attr_mask,
								   uint32_t xfer_mode,
								   uint32_t pci_addr,
 ...
 */
int BSP_VMEDmaListDescriptorEnq (BSP_VMEDmaListDescriptor tail,
...
void BSP_VMEDmaListDescriptorSetUsr (BSP_VMEDmaListDescriptor d,
									 void *usrData);

...
int vmeTsi148OutboundPortCfgXX (BERegister * base,
								unsigned long port,
...
int vmeTsi148OutboundPortCfg (unsigned long port,
							  unsigned long address_space,
							  unsigned long vme_address,
							  unsigned long pci_address,
							  unsigned long length);
...
int vmeTsi148InboundPortCfgXX (BERegister * base,
							   unsigned long port,
							   unsigned long address_space,
							   unsigned long vme_address,
							   unsigned long pci_address,
...
int vmeTsi148InboundPortCfg (unsigned long port,
							 unsigned long address_space,
							 unsigned long vme_address,
							 unsigned long pci_address,
							 unsigned long length);
...
*/
int vmeTsi148MapCRGXX (BERegister * base, uint32_t vme_base,
...
*/
int vmeTsi148InstallISR (unsigned long vector, VmeTsi148ISR handler,
						 void *usrArg);
...
* RETURNS 0 on success, nonzero on failure.
*/
int vmeTsi148RemoveISR (unsigned long vector, VmeTsi148ISR handler,
						void *usrArg);
...
int vmeTsi148InstallIrqMgrVa (int shared, int tsi_pin0, int pic_pin0,
							  va_list ap);
#endif

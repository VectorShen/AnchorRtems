...
static int (*_printf) (char *, int, int, int, int, int, int, int, int, int, int,
					 int, int);
static int (*_cprintf) (char *, int, int, int, int, int, int, int, int, int,
						int, int, int);
static int (*_sprintf) (char *, char *, int, int, int, int, int, int, int, int,
						int, int, int, int);
...
static void (*_memtrace) (char *, int, int, int, int, int, int, int, int, int,
						int, int, int);
...
extern int mon_cprintf (char *fmt,
						int a1, int a2, int a3, int a4, int a5, int a6,
						int a7, int a8, int a9, int a10, int a11, int a12);
extern int mon_sprintf (char *buf,
						char *fmt,
						int a1, int a2, int a3, int a4, int a5, int a6,
						int a7, int a8, int a9, int a10, int a11, int a12);
...
static void DisableMonLock (void)
{
	ignorelock = 2;
}

static void EnableMonLock (void)
{
	ignorelock = 0;
}
#endif
...
int mon_getbytes (char *buf, int cnt, int block)
{
	int ret;
			 ...
			 int a7, int a8, int a9, int a10, int a11, int a12)
{
	...
	GENERIC_MONLOCK ();
	ret =
		_sprintf (buf, fmt, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12);
	GENERIC_MONUNLOCK ();
	return (ret);
}

int mon_restart (int val)
{
	int ret;
...
int mon_setenv (char *name, char *val)
{
	int ret;
...
char *mon_getsym (char *name, char *buf, int bufsize)
{
	char *ret;
...
int mon_tfslink (char *src, char *target)
{
	int ret;
...
int mon_tfsrun (char **name, int verbose)
{
	int ret;
...
struct tfshdr *mon_tfsnext (struct tfshdr *fp)
{
	struct tfshdr *ret;
...
int mon_tfstruncate (int tfd, long len)
{
	int ret;
...
int mon_tfsfstat (char *name, struct tfshdr *fp)
{
	int ret;
...
struct tfshdr *mon_tfsstat (char *name)
{
	struct tfshdr *ret;
...
int mon_tfsread (int fd, char *buf, int cnt)
{
	int ret;
...
int mon_tfswrite (int fd, char *buf, int cnt)
{
	int ret;
...
int mon_tfsopen (char *file, long flagmode, char *buf)
{
	int ret;
...
int mon_tfsclose (int fd, char *info)
{
	int ret;
...
int mon_tfsseek (int fd, int offset, int whence)
{
	int ret;
...
int mon_tfsgetline (int fd, char *bp, int max)
{
	int ret;
...
int mon_tfsipmod (char *name, char *buf, int offset, int size)
{
	int ret;
...
long mon_tfsctrl (int rqst, long arg1, long arg2)
{
	long ret;
...
int mon_addcommand (struct monCommand *cmdlist, char *cmdlvl)
{
	int ret;
...
int mon_docommand (char *cmdline, int verbose)
{
	int ret;
...
unsigned short mon_xcrc16 (char *buf, long nbytes)
{
	unsigned short ret;
...
void mon_intsrestore (unsigned long msr)
{
	GENERIC_MONLOCK ();
	_intsrestore (msr);
	GENERIC_MONUNLOCK ();
...
#ifdef MALLOC_DEBUG
char *mon_malloc (int size, char *fname, int fline)
{
	char *ret;
...
char *mon_realloc (char *buf, int size, char *fname, int fline)
{
	char *ret;
...
int mon_getline (char *buf, int max, int ledit)
{
	int ret;
...
void mon_bbc (char *filename, int lineno)
{
...
int mon_sendenetpkt (char *pkt, int size)
{
	int ret;
...
int mon_recvenetpkt (char *pkt, int size)
{
	int ret;

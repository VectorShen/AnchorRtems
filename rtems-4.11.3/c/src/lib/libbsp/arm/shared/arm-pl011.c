...
bool arm_pl011_probe (rtems_termios_device_context * base)
{
	...
	regs->uartcr = PL011_UARTCR_RXE | PL011_UARTCR_TXE | PL011_UARTCR_UARTEN;

	return true;
}

static bool pl011_first_open (struct rtems_termios_tty *tty,
...
static void pl011_write_support_polled (rtems_termios_device_context * base,

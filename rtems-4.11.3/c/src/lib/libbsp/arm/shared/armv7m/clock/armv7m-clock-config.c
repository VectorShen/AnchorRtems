...
{
	return rtems_timecounter_simple_downcounter_get (tc,
													 _ARMV7M_TC_get,
...
{
	rtems_timecounter_simple_downcounter_tick (&_ARMV7M_TC.base,
											 _ARMV7M_TC_get,
											 _ARMV7M_TC_at_tick);
}
...
{
	_ARMV7M_Set_exception_priority_and_handler (ARMV7M_VECTOR_SYSTICK,
...
static void _ARMV7M_Systick_initialize (void)
{
	...
	systick->csr = ARMV7M_SYSTICK_CSR_ENABLE
		| ARMV7M_SYSTICK_CSR_TICKINT | ARMV7M_SYSTICK_CSR_CLKSOURCE;

	rtems_timecounter_simple_install (&_ARMV7M_TC.base,

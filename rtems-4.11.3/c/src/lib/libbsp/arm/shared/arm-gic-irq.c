...
rtems_status_code bsp_interrupt_facility_initialize (void)
{
	...
	arm_cp15_set_exception_handler (ARM_EXCEPTION_IRQ,
...
rtems_status_code arm_gic_irq_set_priority (rtems_vector_number vector,
											uint8_t priority)
{
	rtems_status_code sc = RTEMS_SUCCESSFUL;
...
rtems_status_code arm_gic_irq_get_priority (rtems_vector_number vector,
											uint8_t * priority)
{
	rtems_status_code sc = RTEMS_SUCCESSFUL;

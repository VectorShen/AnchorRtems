 ...
 */
static uint32_t usart_get_bbr (volatile stm32f4_usart * usart,
							 uint32_t pclk, uint32_t baud)
{
...
static void usart_initialize (int minor)
{
	...
	usart->cr1 = STM32F4_USART_CR1_UE
		| STM32F4_USART_CR1_TE | STM32F4_USART_CR1_RE;
}
...
static ssize_t usart_write_support_polled (int minor, const char *s, size_t n)
{
	ssize_t i = 0;

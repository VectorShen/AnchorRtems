...
rtems_status_code stm32f4_i2c_set_bitrate (stm32f4_i2c_bus_entry * e,
										 uint32_t br)
{
...
static void stm32f4_i2c_handler (void *arg)
{
	...
	else						/* write */
	{
		...
		if ((sr1 & (STM32F4_I2C_SR1_ADDR | STM32F4_I2C_SR1_TxE))
			&& (data <= last))
		{
			regs->dr = *data;
			++data;
...
rtems_status_code stm32f4_i2c_init (stm32f4_i2c_bus_entry * e)
{
	...
	sc = rtems_semaphore_create (rtems_build_name
								 ...
								 RTEMS_INHERIT_PRIORITY, 0, &e->mutex);
...
rtems_status_code stm32f4_i2c_process_message (stm32f4_i2c_bus_entry * e,

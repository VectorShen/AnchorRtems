...
void
rtems_cache_flush_multiple_data_lines_processor_set (const void *addr,
													 size_t size,
...
void
rtems_cache_invalidate_multiple_data_lines_processor_set (const void *addr,
														size_t size,
														const size_t setsize,
														const cpu_set_t * set)
{
...
void
rtems_cache_flush_entire_data_processor_set (const size_t setsize,
											 const cpu_set_t * set)
{
#if defined(CPU_DATA_CACHE_ALIGNMENT)
...
void
rtems_cache_invalidate_entire_data_processor_set (const size_t setsize,
												const cpu_set_t * set)
{
#if defined(CPU_DATA_CACHE_ALIGNMENT)
...
void
rtems_cache_invalidate_multiple_instruction_lines (const void *i_addr,
												 size_t n_bytes)
{
#if defined(CPU_INSTRUCTION_CACHE_ALIGNMENT)
 ...
 */
void
rtems_cache_instruction_sync_after_code_change (const void *code_addr,
												size_t n_bytes)
{

...
typedef mc68681_baud_t
	mc68681_baud_table_t[RTEMS_TERMIOS_NUMBER_BAUD_RATES];
...
void mc68681_set_register (uintptr_t ulCtrlPort,
						   uint8_t ucRegNum, uint8_t ucData);

uint8_t mc68681_get_register_2 (	/* registers are at 2 byte boundaries */
								   uintptr_t ulCtrlPort,	/*   and accessed as bytes            */
								   uint8_t ucRegNum);

void mc68681_set_register_2 (uintptr_t ulCtrlPort,
							 uint8_t ucRegNum, uint8_t ucData);
...
void mc68681_set_register_4 (uintptr_t ulCtrlPort,
							 uint8_t ucRegNum, uint8_t ucData);
...
void mc68681_set_register_8 (uintptr_t ulCtrlPort,
							 uint8_t ucRegNum, uint8_t ucData);

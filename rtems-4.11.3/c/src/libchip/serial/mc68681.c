...
MC68681_STATIC int mc68681_baud_rate (int minor,
									int baud,
...
MC68681_STATIC int mc68681_set_attributes (int minor, const struct termios *t)
{
...
MC68681_STATIC void mc68681_initialize_context (int minor,
												mc68681_context *
												pmc68681Context)
{
	int port;
...
MC68681_STATIC int mc68681_open (int major, int minor, void *arg)
{
	uint32_t pMC68681;
	uint32_t pMC68681_port;
	unsigned int baud;
	...
	if (status < 0)
		rtems_fatal_error_occurred (RTEMS_NOT_DEFINED);
...
MC68681_STATIC int mc68681_close (int major, int minor, void *arg)
{
	uint32_t pMC68681_port;
	setRegister_f setReg;
...
MC68681_STATIC void mc68681_write_polled (int minor, char cChar)
{
	uint32_t pMC68681_port;
...
MC68681_STATIC rtems_isr mc68681_isr (rtems_vector_number vector)
{
	int minor;
...
MC68681_STATIC ssize_t mc68681_write_support_int (int minor,
...
MC68681_STATIC ssize_t mc68681_write_support_polled (int minor,
													 const char *buf,
													 size_t len)
{
	int nwrite = 0;
...
MC68681_STATIC int mc68681_inbyte_nonblocking_polled (int minor)
{
	uint32_t pMC68681_port;
	unsigned char ucLineStatus;
	unsigned char cChar;
...
MC68681_STATIC void mc68681_process (int minor)
{
	uint32_t pMC68681;
	uint32_t pMC68681_port;
	...
	while (true)
	{
		...
		cChar = (*getReg) (pMC68681_port, MC68681_RX_BUFFER);
		rtems_termios_enqueue_raw_characters (Console_Port_Data[minor].
												termios_data, &cChar, 1);
	}
...
MC68681_STATIC unsigned int mc68681_build_imr (int minor, int enable_flag)
{
	int mate;
	int is_a;
	unsigned int mask;
	...
	pMC68681_port = Console_Port_Tbl[minor]->ulCtrlPort2;
	pmc68681Context =
		(mc68681_context *) Console_Port_Data[minor].pDeviceContext;
...
MC68681_STATIC void mc68681_enable_interrupts (int minor, int imr_mask)
{
	uint32_t pMC68681;
	setRegister_f setReg;
	...
	(*setReg) (pMC68681,
			 MC68681_INTERRUPT_MASK_REG, mc68681_build_imr (minor, imr_mask));
}

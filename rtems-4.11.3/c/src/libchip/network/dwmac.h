 ...
 */
	typedef int (*dwmac_if_nic_enable) (void *arg);
 ...
 * @see dwmac_network_if_attach_detach for the attach_detach method.
 */
	typedef int (*dwmac_if_nic_disable) (void *arg);
 ...
 * @see dwmac_network_if_attach_detach for the attach_detach method.
 */
	typedef int (*dwmac_if_phy_enable) (void *arg);
 ...
 * @see dwmac_network_if_attach_detach for the attach_detach method.
 */
	typedef int (*dwmac_if_phy_disable) (void *arg);
 ...
 */
	typedef int
		(*dwmac_if_phy_event_enable) (void *arg,
 ...
 * @see dwmac_network_if_attach_detach for the attach_detach method.
 */
	typedef int (*dwmac_if_phy_event_status_clear) (void *arg);
 ...
 */
	typedef int
		(*dwmac_if_phy_events_status_get) (void *arg,
 ...
 * @see dwmac_network_if_attach_detach for the attach_detach method.
 */
	typedef int (*dwcmac_if_phy_start) (void *arg);
 ...
 * @see dwmac_network_if_attach_detach for the attach_detach method.
 */
	typedef int (*dwcmac_if_phy_stop) (void *arg);
 ...
 */
	typedef int
		(*dwmac_if_mem_alloc_nocache) (void *arg,
 ...
 * @see dwmac_network_if_attach_detach for the attach_detach method.
 */
	typedef int (*dwmac_if_mem_free_nocache) (void *arg, void *memory);
 ...
 * @see dwmac_network_if_attach_detach for the attach_detach method.
 */
	typedef int (*dwmac_if_bus_setup) (void *arg);
 ...
 */
	void *dwmac_network_if_attach_detach (struct rtems_bsdnet_ifconfig
										  *bsd_config,
 ...
 */
	int dwmac_if_read_from_phy (void *arg,
								const unsigned phy_reg, uint16_t * val);

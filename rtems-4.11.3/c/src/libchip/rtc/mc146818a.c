 ...
 */
bool mc146818a_probe (int minor)
{
	uint32_t mc146818a;
 ...
 * Initialize chip
 */
static void mc146818a_initialize (int minor)
{
	uintptr_t mc146818a;
	...
	(*setReg) (mc146818a,
			 MC146818A_STATUSA, MC146818ASA_DIVIDER | MC146818ASA_1024);
 ...
 * Read time from chip
 */
static int mc146818a_get_time (int minor, rtems_time_of_day * time)
{
	uintptr_t mc146818a;
	getRegister_f getReg;
	uint32_t value;
 ...
 * Set time into chip
 */
static int mc146818a_set_time (int minor, const rtems_time_of_day * time)
{
	uint32_t mc146818a;
	setRegister_f setReg;
	 ...
	 * Stop the RTC
	 */
	(*setReg) (mc146818a, MC146818A_STATUSB,
			 MC146818ASB_HALT | MC146818ASB_24HR);

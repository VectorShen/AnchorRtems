...
static void icm7170_initialize (int minor)
{
	uintptr_t icm7170;
...
static int icm7170_get_time (int minor, rtems_time_of_day * time)
{
	uint32_t icm7170;
...
static int icm7170_set_time (int minor, const rtems_time_of_day * time)
{
	uintptr_t icm7170;
	setRegister_f setReg;
	uint32_t year;

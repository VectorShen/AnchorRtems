...
static void m48t08_initialize (int minor)
{
}
...
static int m48t08_get_time (int minor, rtems_time_of_day * time)
{
	uint32_t m48t08;
...
static int m48t08_set_time (int minor, const rtems_time_of_day * time)
{
	uint32_t m48t08;
	getRegister_f getReg;
	setRegister_f setReg;

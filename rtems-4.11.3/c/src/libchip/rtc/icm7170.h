...
void icm7170_set_register (uintptr_t ulCtrlPort,
						   uint8_t ucRegNum, uint32_t ucData);

uint32_t icm7170_get_register_2 (	/* registers are at 2 byte boundaries */
									uintptr_t ulCtrlPort,	/*   and accessed as bytes            */
									uint8_t ucRegNum);

void icm7170_set_register_2 (uintptr_t ulCtrlPort,
							 uint8_t ucRegNum, uint32_t ucData);
...
void icm7170_set_register_4 (uintptr_t ulCtrlPort,
							 uint8_t ucRegNum, uint32_t ucData);
...
void icm7170_set_register_8 (uintptr_t ulCtrlPort,
							 uint8_t ucRegNum, uint32_t ucData);

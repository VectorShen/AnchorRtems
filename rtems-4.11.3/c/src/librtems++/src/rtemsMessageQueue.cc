...
rtemsMessageQueue::
rtemsMessageQueue (const rtemsMessageQueue & message_queue):name (0),
owner (false), id (0)
{
...
rtemsMessageQueue::rtemsMessageQueue ():name (0), owner (false), id (0)
{
	strcpy (name_str, "NOID");
}
...
const rtemsMessageQueue & rtemsMessageQueue::
operator= (const rtemsMessageQueue & message_queue)
{
	if (!owner)
	{
		name = message_queue.name;
